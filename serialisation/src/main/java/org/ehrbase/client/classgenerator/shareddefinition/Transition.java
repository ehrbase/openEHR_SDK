...
public enum Transition implements EnumValueSet {
    CANCEL(
            ...
            "openehr",
            "166",
            List.of(State.PLANNED, State.SCHEDULED, State.POSTPONED),
            State.CANCELLED),
    ...
    TIME_OUT(
            ...
            "openehr",
            "549",
            List.of(State.PLANNED, State.POSTPONED, State.SCHEDULED, State.SUSPENDED, State.ACTIVE),
            State.EXPIRED),
    ...
    Transition(
            String value, String description, String terminologyId, String code, State sourceState, State targetState) {

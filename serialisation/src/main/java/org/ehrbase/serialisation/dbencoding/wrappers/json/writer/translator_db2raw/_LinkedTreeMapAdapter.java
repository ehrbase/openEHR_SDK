    ...
    for (Object entry : map.entrySet()) {
      if (entry instanceof Map.Entry) {
        ...
        if (value instanceof ArrayList) {
          ...
          //                    System.out.println("ARRAY items:" + key + " isTerminal:" +
          // terminalNode);
          if (terminalNode) {
            if (!inArray) writer.name(jsonKey);
          ...
          //                    if (((LinkedTreeMap)
          // value).containsKey(CompositionSerializer.TAG_PATH)) {
          //                        writer.name(AT_CLASS).value("ELEMENT");
          //                    }
      ...
      } else throw new IllegalArgumentException("Entry is not a map:" + entry);
    }
    ...
    for (Object object : list) {
      ...
      if (object instanceof LinkedTreeMap) {
        for (Object entry : ((LinkedTreeMap) object).entrySet()) {
          ...
          //                        continue;
          ////                    if (!(itemKey.contains(ITEMS)) &&
          // !(itemKey.equals(CompositionSerializer.TAG_NAME)))
          ////                        return true;

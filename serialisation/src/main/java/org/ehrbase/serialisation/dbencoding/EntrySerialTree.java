...
public class EntrySerialTree extends SerialTree {
    ...
    public Map<String, Object> insert(Composition composition, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            case TAG_COMPOSITION:
                retMap = super.insert(
                        composition, new NodeEncoding(tagMode).tag(TAG_COMPOSITION, composition, map), addStructure);
                break;
            default:
                retMap = map;
        }
    ...
    public Map<String, Object> insert(ContentItem contentItem, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            case TAG_CONTENT:
                ...
                retMap = super.insert(
                        contentItem, new NodeEncoding(tagMode).tag(TAG_CONTENT, contentItem, map), addStructure);
                break;
            default:
                retMap = map;
        }
    ...
    public Map<String, Object> insert(Observation observation, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            ...
            case TAG_DATA:
                retMap = super.insert(
                        observation, new NodeEncoding(tagMode).tag(TAG_DATA, observation.getData(), map), addStructure);
                break;
            case TAG_STATE:
                retMap = super.insert(
                        observation,
    ...
    public Map<String, Object> insert(Evaluation evaluation, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            ...
            case TAG_DATA:
                retMap = super.insert(
                        evaluation, new NodeEncoding(tagMode).tag(TAG_DATA, evaluation.getData(), map), addStructure);
                break;
            default:
                retMap = map;
        }
    ...
    public Map<String, Object> insert(Activity activity, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            case TAG_ACTIVITIES:
                retMap = super.insert(
                        activity, new NodeEncoding(tagMode).tag(TAG_ACTIVITIES, activity, map), addStructure);
                break;
    ...
    public Map<String, Object> insert(Action action, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            case TAG_PROTOCOL:
                retMap = super.insert(
                        action, new NodeEncoding(tagMode).tag(TAG_PROTOCOL, action.getProtocol(), map), addStructure);
                break;
            case TAG_DESCRIPTION:
                retMap = super.insert(
                        action,
    ...
    public Map<String, Object> insert(Event<?> event, String attribute, Object addStructure) {
        ...
        switch (attribute) {
            ...
            case TAG_STATE:
                retMap = super.insert(
                        event, new NodeEncoding(tagMode).tag(TAG_STATE, event.getState(), map), addStructure);
                break;
            default:
                retMap = map;
        }

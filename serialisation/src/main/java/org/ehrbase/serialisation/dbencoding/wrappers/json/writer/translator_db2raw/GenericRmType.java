...
public class GenericRmType {
  ...
  /**
   * identify the RmType used to specialized the type f.e. DV_QUANTITY in DV_INTERVAL<DV_QUANTITY>
   *
  ...
  /**
   * add the type in each datavalues for this instance. F.e. add the _type for lower and upper in an
   * interval
   *

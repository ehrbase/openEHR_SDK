...
public abstract class TemporalAttributes implements I_TemporalAttributes {
  ...
  /**
   * ChronoField as bitmask 4 bytes 76543210765432107654321076543210
   * 00000000000000000000000000000000 type + ext. + date + time + ext -> future extensions if
   * applicable
   */
  ...
  /**
   * SQL formatter depending on the actual bitmask and attributes to be used with to_char(timestamp,
   * text) (https://www.postgresql.org/docs/current/functions-formatting.html)
   */
  ...
  static {
    ...
    ISODateTimeSQLFormatters.put(
        DV_DATE_TIME | YEAR | MONTH_OF_YEAR | DAY_OF_MONTH | HOUR | MINUTE_OF_HOUR,
    ...
    ISODateTimeSQLFormatters.put(
        DV_TIME | HOUR | MINUTE_OF_HOUR | SECOND_OF_MINUTE, "YYYY-MM-DD\"T\"HH24:MI:SS");
    ISODateTimeSQLFormatters.put(

 ...
 *
 * <p>The AOM class CComplexObject will get the type name "C_COMPLEX_OBJECT" The RM class DvDateTime
 * will get the type name "DV_DATE_TIME"
 */
public class OpenEHRTypeNaming extends ClassNameIdResolver {
  ...
  public String idFromValue(Object value) {
    ...
    if (typeInfo != null) {
      // this case is faster and should always work. If for some reason it does not, the case below
      // works fine instead.
      return typeInfo.getRmName();
    } else {
      return rmInfoLookup.getNamingStrategy().getTypeName(value.getClass());
    }
    // This should work in all cases for openEHR-classes and this should not be used for other
    // classes

...
import org.ehrbase.serialisation.std.marshal.FlatJsonMarshaller;
import org.ehrbase.serialisation.std.umarshal.FlatJsonUnmarshaller;
...
public class FlatJson implements RMDataFormat {
    ...
    public String marshal(RMObject rmObject) {
        if (rmObject instanceof Composition) {
            ...
            throw new SdkException(String.format("Class %s not supported in flat format", rmObject.getClass().getSimpleName()));
        }
    }

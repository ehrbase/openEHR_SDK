...
import static org.ehrbase.openehr.sdk.serialisation.flatencoding.std.marshal.StdFromCompositionWalker.findStdConfig;
...
public class FeederAudiDetailsStdConfig extends AbstractsStdConfig<FeederAuditDetails> {
    ...
    public Map<String, Object> buildChildValues(
        ...
        addValue(
                ...
                currentTerm,
                "time",
                Optional.ofNullable(rmObject.getTime())

...
public class DvDateTimePostprocessor extends AbstractMarshalPostprocessor<DvDateTime> {
    ...
    @Override
    public void process(
            String term, DvDateTime rmObject, Map<String, Object> values, Context<Map<String, Object>> context) {
        // Serialize temporal accessor here, if part of values, to avoid archie serialization
        values.computeIfPresent(term, (k, v) -> OpenEHRDateTimeSerializationUtils.formatDateTime(rmObject.getValue()));
    }

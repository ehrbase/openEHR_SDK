...
public class RoundTripTest {
    ...
    public void testRoundTrip() throws IOException {
        ...
        testCaseList.add(new TestCase(
                ...
                CompositionTestDataSimSDTJson.CORONA,
                "Corona_Anamnese",
                org.ehrbase.openehr.sdk.generator.commons.test_data.dto.optimizersettingsections
                        .CoronaAnamneseComposition.class,
                new String[] {},
                new String[] {}));
        ...
        testCaseList.add(new TestCase(
                ...
                CompositionTestDataSimSDTJson.CORONA,
                "Corona_Anamnese",
                org.ehrbase.openehr.sdk.generator.commons.test_data.dto.optimizersettingalls.CoronaAnamneseComposition
                        .class,
                new String[] {},
                new String[] {}));
    ...
    public void checkTestCase(TestCase testCase, SoftAssertions softly) throws IOException {
        ...
        Object flatten = rmToGeneratedDtoConverter.toGeneratedDto(composition, testCase.dtoClass);

        GeneratedDtoToRmConverter generatedDtoToRmConverter =
                new GeneratedDtoToRmConverter(new TestDataTemplateProvider());
        RMObject actual = generatedDtoToRmConverter.toRMObject(flatten);

...
public class FolderSerializerTest {
  ...
  public void marshalBasicJsonFolder() throws IOException {
    ...
    String value =
        IOUtils.toString(FolderTestDataCanonicalJson.SIMPLE_EMPTY_FOLDER.getStream(), UTF_8);
  ...
  public void marshalBasicXmlFolder() throws IOException {
    ...
    String value =
        IOUtils.toString(FolderTestDataCanonicalXML.SIMPLE_EMPTY_FOLDER.getStrean(), UTF_8);
    ...
    assertThat(marshalled)
        .containsSubsequence("<name>", "<value>", "Simple empty folder", "</value>", "</name>");
  }
}

...
public class DBEncodeRoundTripTest {
  ...
  public void testRoundTrip() throws IOException {
    ...
    testCaseList.add(
        new TestCase(
            ...
            new String[] {
              "Extra path: test_all_types/_uid, value: bb015b91-68c0-460f-a458-8ef06869b53c::piri.ehrscape.com::1",
    ...
    testCaseList.add(
        new TestCase(
            ...
            new String[] {},
            new String[] {
              "Extra path: bericht/_uid, value: 93a018f1-ad95-4d52-bb8f-0f64d7f7cce6::piri.ehrscape.com::1",
    ...
    testCaseList.add(
        new TestCase(
            ...
            new String[] {
              "Extra path: bericht/_uid, value: 655ab9fb-9454-4540-a52c-83ce4bdf765d::piri.ehrscape.com::1",
    ...
    testCaseList.add(
        new TestCase(
            ...
            new String[] {
              "Extra path: encounter/_uid, value: 95705e9e-d658-4e60-8e42-240db4478179::piri.ehrscape.com::1",
  ...
  public void testActivityRoundTrip() throws IOException {
    String value =
        new String(
            Files.readAllBytes(
                Paths.get("src/test/resources/sample_data/test_all_types_activity_flat.json")));
    FlatJson flatJson =
        new FlatJasonProvider(new TestDataTemplateProvider())
  ...
  public void testIsmTransitionRoundTrip() throws IOException {
    String value =
        new String(
            Files.readAllBytes(
                Paths.get(
                    "src/test/resources/sample_data/test_all_types_ism_transition_flat.json")));
    FlatJson flatJson =
        new FlatJasonProvider(new TestDataTemplateProvider())
            .buildFlatJson(FlatFormat.SIM_SDT, "test_all_types.en.v1");
  ...
  public void testCountRoundTrip() throws IOException {
    String value =
        new String(
            Files.readAllBytes(
                Paths.get("src/test/resources/sample_data/test_all_type_count_flat.json")));
    FlatJson flatJson =
        new FlatJasonProvider(new TestDataTemplateProvider())
            .buildFlatJson(FlatFormat.SIM_SDT, "test_all_types.en.v1");
  ...
  public void testMathFunctionRoundTrip() throws IOException {
    String value =
        new String(
            Files.readAllBytes(
                Paths.get("src/test/resources/sample_data/corona_math_function_flat.json")));
    FlatJson flatJson =
        new FlatJasonProvider(new TestDataTemplateProvider())
  ...
  public void testAlternativeEventsRoundTrip() throws IOException {
    String value =
        new String(
            Files.readAllBytes(
                Paths.get("src/test/resources/sample_data/alternative_events_reduced_flat.json")));
    FlatJson flatJson =
        new FlatJasonProvider(new TestDataTemplateProvider())

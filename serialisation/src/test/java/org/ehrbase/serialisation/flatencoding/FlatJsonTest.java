...
public class FlatJsonTest {
  ...
  public void roundTripDeterioriationAssessment() throws IOException {
    ...
    String[] expectedMissing = {"Missing path: deterioration_assessment/assessment/news2/respirations/rate|magnitude, value: 110.0",
    ...
    String[] expectedExtra = {"Extra path: deterioration_assessment/assessment/news2/blood_pressure/diastolic|magnitude, value: 60",
  ...
  public void roundTripAll() throws IOException {
    ...
    String[] expectedMissing = { "Missing path: test_all_types/test_all_types:0/identifier|id, value: 55175056",
            "Missing path: test_all_types/test_all_types:0/proportion_any|type, value: 1"};

    String[] expectedExtra = { "Extra path: test_all_types/test_all_types:0/identifier, value: 55175056",
  ...
  public void roundTripAlt() throws IOException {
    ...
    String[] expectedMissing = {  "Missing path: bericht/körpergewicht:0/birth_en/gewicht|magnitude, value: 30.0",
    ...
    String[] expectedExtra = {  "Extra path: bericht/körpergewicht:0/any_event_en:0/gewicht|magnitude, value: 55",
  ...
  public void roundTripMulti() throws IOException {
    ...
    String[] expectedMissing = {   "Missing path: encounter/body_temperature:0/any_event:0/temperature|magnitude, value: 22.0",
    ...
    String[] expectedExtra = { "Extra path: encounter/body_temperature:0/any_event:0/temperature|magnitude, value: 22",
  ...
  public void roundTripMissingCount() throws IOException {
    ...
    String[] expectedExtra = {   "Extra path: encounter/body_temperature:0/any_event/temperature|magnitude, value: 22",

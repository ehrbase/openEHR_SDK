...
import org.ehrbase.openehr.sdk.conformance_test.extern.CompositionConverterImp;
    ...
    public void emptyComposition() throws Exception {
        ...
        JsonNode rawComposition = new CompositionConverterImp()
                .convertStructuredToRaw(
                        template,
                        "ru",
                        WorkflowIdTestOverwrite.OBJECT_MAPPER.writeValueAsString(Collections.emptyMap()),
                        ImmutableMap.of(
                                ...
                                "Composer"),
                        WorkflowIdTestOverwrite.OBJECT_MAPPER);

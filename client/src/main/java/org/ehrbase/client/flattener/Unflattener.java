...
public class Unflattener {
    ...
    /**
     * Extracts the {@code VersionUid} of the dto from a property annotated with {@code @Id}
     *
     * @param dto
     * @return
     */
    static Optional<VersionUid> extractVersionUid(Object dto) {
        return Arrays.stream(dto.getClass().getDeclaredFields())
                ...
                .map(idField -> {
                    try {
                        ...
                        return (VersionUid) propertyDescriptor.getReadMethod().invoke(dto);

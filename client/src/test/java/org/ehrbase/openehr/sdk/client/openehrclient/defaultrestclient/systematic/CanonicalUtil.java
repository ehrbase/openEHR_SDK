...
import org.ehrbase.openehr.sdk.util.SnakeToCamel;
...
public abstract class CanonicalUtil {
    ...
    public static Object valueObject(Object anObject) {
        ...
        if (anObject instanceof Map) {
            ...
            if (((Map) anObject).containsKey("_type")) {
                // get the actual type from Archie lookup
                Class objectRmClass = ArchieRMInfoLookup.getInstance().getClass((String) ((Map) anObject).get("_type"));
    ...
    public static List<RMObject> toRmObjectList(List<Object> rmObjectListAsMap) {
        ...
        for (Object item : rmObjectListAsMap) {
            if (item instanceof Map) {
                ...
                // get the type
                String type = (String) mappedObject.get("_type");

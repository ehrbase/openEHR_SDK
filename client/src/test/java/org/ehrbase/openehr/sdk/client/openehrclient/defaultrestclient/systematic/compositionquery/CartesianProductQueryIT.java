...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.minimalaction3env1composition.MinimalAction3EnV1Composition;
...
public class CartesianProductQueryIT extends CanonicalUtil {
    ...
    public void testCartesianWithOptionalAttribute() throws IOException {
        ...
        Composition compoWithAttribute = new CanonicalJson()
                .unmarshal(
                        IOUtils.toString(
                                CompositionTestDataCanonicalJson.MINIMAL_WITH_OPTIONAL_ATTRIBUTE.getStream(),
                                StandardCharsets.UTF_8),
                        Composition.class);
        Composition compoWithoutAttribute = new CanonicalJson()
                .unmarshal(
                        IOUtils.toString(
                                CompositionTestDataCanonicalJson.MINIMAL_WITHOUT_OPTIONAL_ATTRIBUTE.getStream(),
                                StandardCharsets.UTF_8),
                        Composition.class);

        MinimalAction3EnV1Composition minimalAction3EnV1CompositionWithAttribute =
                rmToGeneratedDtoConverter.toGeneratedDto(compoWithAttribute, MinimalAction3EnV1Composition.class);
        MinimalAction3EnV1Composition minimalAction3EnV1CompositionWithoutAttribute =
                rmToGeneratedDtoConverter.toGeneratedDto(compoWithoutAttribute, MinimalAction3EnV1Composition.class);
        ...
        List<Record3<String, String, Integer>> result =
                openEhrClient.aqlEndpoint().execute(query);

        assertThat(result.size())
                .as("Should have 2 rows resulting from cartesian product")
                .isEqualTo(2);
    }
}

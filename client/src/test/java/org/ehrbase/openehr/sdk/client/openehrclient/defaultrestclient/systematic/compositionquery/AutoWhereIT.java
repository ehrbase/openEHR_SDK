...
import org.ehrbase.openehr.sdk.client.openehrclient.defaultrestclient.systematic.compositionquery.queries.auto.AutoWhereQuery;
...
public class AutoWhereIT extends CanonicalCompoAllTypeQueryIT {
    ...
    public void testActionAutoWhere() throws IOException {
        ...
        assertThat(autoWhereQuery.testItemPaths(csvTestSet, rootPath, contains, referenceNode))
                .isTrue();
    }

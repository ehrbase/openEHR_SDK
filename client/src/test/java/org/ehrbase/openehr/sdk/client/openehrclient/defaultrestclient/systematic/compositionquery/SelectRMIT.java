...
public class SelectRMIT extends CanonicalCompoAllTypeQueryIT {
    ...
    public void testCompositionAttributeQuery() throws IOException {
        ...
        BufferedReader inputCSVSetReader =
                new BufferedReader(new FileReader("src/test/resources/testsets/testCompositionAttributeQuery.csv"));
        ...
        while ((csvParams = inputCSVSetReader.readLine()) != null) {
            ...
            if (params.length == 1) { // conventionally, if params[1] exists, this means skip the test
                QueryResponseData result = simpleSelectQueryEngine.performQuery(
                        rootPath, attributePath, "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]");

                List<Object> objectList = result.getRows().get(0);

                // special case, c/uid is actually completed after db insertion, hence cannot be compared with the
                // initial
                // null value
                if (attributePath.contains("uid")) {
                    assertThat(objectList.get(0)).isNotNull();
                } else
                    Assertions.assertThat(CanonicalUtil.valueObject(objectList.get(0)))
                            .as(rootPath + "/" + attributePath)
                            .isEqualTo(CanonicalUtil.attributeValueAt(referenceNode, attributePath));
            }
        }
    }
    ...
    public void testContextAttributesDrillDown() throws IOException {
        ...
        assertThat(simpleSelectQueryEngine.testItemPaths(csvTestSet, rootPath, contains, referenceNode))
                .isTrue();
    }
    ...
    public void testObservationDrillDown() throws IOException {
        ...
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath("/content[openEHR-EHR-OBSERVATION.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
    ...
    public void testEvaluationDrillDown() throws IOException {
        ...
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath("/content[openEHR-EHR-EVALUATION.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
    ...
    public void testSectionDrillDown() throws IOException {
        ...
        String rootPath = "s";
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath("/content[openEHR-EHR-SECTION.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
    ...
    public void testInstructionDrillDown() throws IOException {
        ...
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath(
                        "/content[openEHR-EHR-SECTION.test_all_types.v1]/items[at0001]/items[at0002]/items[openEHR-EHR-INSTRUCTION.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
                + " contains section s[openEHR-EHR-SECTION.test_all_types.v1]"
    ...
    public void testActionDrillDown() throws IOException {
        ...
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath(
                        "/content[openEHR-EHR-SECTION.test_all_types.v1]/items[at0001]/items[at0002]/items[openEHR-EHR-ACTION.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
                + " contains section s[openEHR-EHR-SECTION.test_all_types.v1]"
    ...
    public void testAdminEntryDrillDown() throws IOException {
        ...
        RMObject referenceNode = (RMObject) aComposition
                .itemsAtPath(
                        "/content[openEHR-EHR-SECTION.test_all_types.v1]/items[at0001]/items[openEHR-EHR-ADMIN_ENTRY.test_all_types.v1]")
                .get(0);
        String contains = "composition c[openEHR-EHR-COMPOSITION.test_all_types.v1]"
                + " contains section s[openEHR-EHR-SECTION.test_all_types.v1]"

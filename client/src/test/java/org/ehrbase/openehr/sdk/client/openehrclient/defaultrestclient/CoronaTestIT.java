...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.coronaanamnesecomposition.definition.FieberOderErhohteKorpertemperaturObservationContainment;
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.coronaanamnesecomposition.definition.HeiserkeitObservationContainment;
...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.coronaanamnesecomposition.definition.ReisefallObservationContainment;
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.coronaanamnesecomposition.definition.RisikogebietSectionContainment;
...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.patientenaufenthaltcomposition.definition.AbteilungsfallClusterContainment;
...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.patientenaufenthaltcomposition.definition.StandortschlusselDefiningCode;
...
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.stationarerversorgungsfallcomposition.StationarerVersorgungsfallCompositionContainment;
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.stationarerversorgungsfallcomposition.definition.AufnahmedatenAdminEntryContainment;
import org.ehrbase.openehr.sdk.generator.commons.test_data.dto.stationarerversorgungsfallcomposition.definition.EntlassungsdatenAdminEntryContainment;
...
public class CoronaTestIT {
    ...
    public void testCorona() throws IOException {
        ...
        CoronaAnamneseComposition coronaAnamneseComposition =
                rmToGeneratedDtoConverter.toGeneratedDto(composition, CoronaAnamneseComposition.class);
        openEhrClient.compositionEndpoint(ehr).mergeCompositionEntity(coronaAnamneseComposition);

        assertThat(openEhrClient
                        .compositionEndpoint(ehr)
                        .find(
                                UUID.fromString(coronaAnamneseComposition
                                        .getVersionUid()
                                        .getObjectId()
                                        .getValue()),
        ...
        EntityQuery<Record4<VorhandenDefiningCode, VorhandenDefiningCode, VorhandenDefiningCode, Language>>
         ...
         */
        List<Record4<VorhandenDefiningCode, VorhandenDefiningCode, VorhandenDefiningCode, Language>> actual =
    ...
    public void testCoronaWithJoin() throws IOException {
        ...
        ContainmentExpression containmentExpression =
                coronaAnamneseCompositionContainment.contains(symptomeSectionContainment
                        .contains(hustenObservationContainment)
    ...
    public void testNUMResearchCase_3() throws IOException {
        ...
        ContainmentExpression containmentExpression = virologischerBefundCompositionContainment.contains(
                probeClusterContainment.and(kulturClusterContainment.contains(proVirusClusterContainment)));
    ...
    public void testNUMResearchCase_5() {
        ...
        ContainmentExpression containmentExpression =
                patientenaufenthaltCompositionContainment.contains(abteilungsfallClusterContainment.and(
    ...
    public void testNUMResearchCase_6() {
        ...
        // build AQL
        StationarerVersorgungsfallCompositionContainment stationarerVersorgungsfallCompositionContainment =
        ...
        ContainmentExpression containmentExpression = stationarerVersorgungsfallCompositionContainment.contains(
    ...
    public void testNUMResearchCase_8() {
        ...
        ContainmentExpression containmentExpression =
                compositionContainment.contains(befundObservationContainment.contains(
                        kulturClusterContainment.and(probeClusterContainment.and(proVirusClusterContainment))));

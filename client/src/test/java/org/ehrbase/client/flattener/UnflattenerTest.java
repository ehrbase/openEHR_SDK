...
public class UnflattenerTest {
    ...
    public void testUnflattenInterval() {
        ...
        TestAllTypesEnV1Composition actual =
                new Flattener(new TestDataTemplateProvider()).flatten(rmObject, TestAllTypesEnV1Composition.class);

        assertThat(actual.getTestAllTypes2().get(0).isIntervalCountUpperIncluded())
                .isTrue();
    }

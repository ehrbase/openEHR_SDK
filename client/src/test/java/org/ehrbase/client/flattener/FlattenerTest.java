...
public class FlattenerTest {
    ...
    public void testFlattenEhrbaseBloodPressureSimpleDeV0() {
        ...
        assertThat(actual.getBloodPressureTrainingSample().get(0).getMeanArterialPressureNullFlavourDefiningCode())
                .isNull();
    }
    ...
    public void testFlattenAltEvents() {
        Composition composition = (Composition)
                new Unflattener(new TestDataTemplateProvider()).unflatten(buildAlternativeEventsComposition());
        Flattener cut = new Flattener(new TestDataTemplateProvider());
    ...
    public void testFlattenEpisodeOfCare() {
        Composition composition = (Composition)
                new Unflattener(new TestDataTemplateProvider()).unflatten(buildEpisodeOfCareComposition());
        Flattener cut = new Flattener(new TestDataTemplateProvider());

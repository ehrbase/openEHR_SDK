...
public class DefaultRestCompositionEndpointIT {
    ...
    public void testSaveCompositionEntity() {
        ...
        bloodPressureSimpleDeV0.setVersionUid(new VersionUid(
    ...
    public void testSaveCompositionEntityNative() {
        ...
        Optional<Composition> aNative = openEhrClient
                ...
                .findRaw(bloodPressureSimpleDeV0.getVersionUid().getUuid());
    ...
    public void testSaveCompositionEntityProxy() {
        ...
        proxy.setVersionUid(new VersionUid(
                proxy.getVersionUid().getUuid(), proxy.getVersionUid().getSystem(), 1L));
    ...
    public void testSaveCompositionEntityCgiProxy() {
        ...
        EhrbaseBloodPressureSimpleDeV0Composition actual = openEhrClient
                .compositionEndpoint(ehr)
                .find(proxy.getVersionUid().getUuid(), EhrbaseBloodPressureSimpleDeV0Composition.class)
                .get();
    ...
    public void testEpisodeOfCare() {
        ...
        Optional<EpisodeOfCareComposition> actual =
                compositionEndpoint.find(version1.getVersionUid().getUuid(), EpisodeOfCareComposition.class);
        assertTrue(actual.isPresent());
    ...
    public void testDeleteCompositionValid() {
        ...
        result = compositionEndpoint.find(
                composition.getVersionUid().getUuid(), EhrbaseBloodPressureSimpleDeV0Composition.class);
    ...
    public void testDeleteCompositionInvalidPrecedingVersionUid() {
        ...
        VersionUid precedingVersionUid = new VersionUid(

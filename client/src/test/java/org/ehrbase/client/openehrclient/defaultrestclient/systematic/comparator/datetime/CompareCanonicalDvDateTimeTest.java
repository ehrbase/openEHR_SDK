...
public class CompareCanonicalDvDateTimeTest extends CanonicalUtil {
    ...
    public void testComparatorDvDateTime() {
        ...
        assertThat(new CompareCanonicalDvDateTime(dvDateTime).isExpectedEqualToCanonicalUsing(dvDateTime))
                .isNull();
        assertThat(new CompareCanonicalDvDateTime(dvDateTime)
                        .setCompareDateOnly(true)
                        .isExpectedEqualToCanonicalUsing(dvDateTime))
                .isNull();
        assertThat(new CompareCanonicalDvDateTime(dvDateTime)
                        .setCompareDateOnly(false)
                        .isExpectedEqualToCanonicalUsing(dvDateTime))
                .isNull();
    }
    ...
    public void testComparatorDvTime() {
        ...
        assertThat(new CompareCanonicalDvTime(dvTime).isExpectedEqualToCanonicalUsing(dvTime))
                .isNull();
    }
    ...
    public void testComparatorDvDate() {
        ...
        assertThat(new CompareCanonicalDvDate(dvDate).isExpectedEqualToCanonicalUsing(dvDate))
                .isNull();
    }
}

...
public class DefaultDirectoryCrudEndpointTestIT {
    ...
    public void testCreate() {
        ...
        VersionUid version = directoryCrudEndpoint.createDirectory(folder);
    ...
    public void testUpdate() {
        ...
        VersionUid newVersionUid = directoryCrudEndpoint.updateDirectory(oldFolder);

        assertThat(newVersionUid.getVersion()).isEqualTo(2L);

...
public class ConditionTest {
    ...
    public void testBuildAqlNot() {
        ...
        assertThat(cut.buildAql()).isEqualTo("NOT (v/data[at0001]/events[at0002]/data[at0003]/items[at0005]/value/magnitude >= 13.0 and (v/data[at0001]/events[at0002]/data[at0003]/items[at1006]/value/units != 'mh' or v/data[at0001]/events[at0002]/time/value < '2019-04-03T22:00:00Z'))");
    ...
    public void testBuildAqlNot2() {
        ...
        assertThat(cut.buildAql()).isEqualTo("NOT (v/data[at0001]/events[at0002]/data[at0003]/items[at0005]/value/magnitude >= 13.0 and v/data[at0001]/events[at0002]/data[at0003]/items[at1006]/value/units != 'mh' and v/data[at0001]/events[at0002]/time/value < '2019-04-03T22:00:00Z')");

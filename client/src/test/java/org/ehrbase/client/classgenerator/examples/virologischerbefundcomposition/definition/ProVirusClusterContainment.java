...
public class ProVirusClusterContainment extends Containment {
  ...
  public SelectAqlField<String> NACHWEIS_VALUE = new AqlFieldImp<String>(ProVirusCluster.class, "/items[at0001]/value|value", "nachweisValue", String.class, this);

  public SelectAqlField<Double> VIRUSLAST_CT_WERT_MAGNITUDE = new AqlFieldImp<Double>(ProVirusCluster.class, "/items[at0001]/value|magnitude", "viruslastCtWertMagnitude", Double.class, this);

  public SelectAqlField<String> VIRUSLAST_CT_WERT_UNITS = new AqlFieldImp<String>(ProVirusCluster.class, "/items[at0001]/value|units", "viruslastCtWertUnits", String.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(ProVirusCluster.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

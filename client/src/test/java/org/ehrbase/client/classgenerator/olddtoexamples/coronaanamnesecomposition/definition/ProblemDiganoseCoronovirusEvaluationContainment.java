...
public class ProblemDiganoseCoronovirusEvaluationContainment extends Containment {
  ...
  public SelectAqlField<StatusCluster> STATUS =
      new AqlFieldImp<StatusCluster>(
          ProblemDiganoseCoronovirusEvaluation.class,
          "/data[at0001]/items[openEHR-EHR-CLUSTER.problem_qualifier.v1 and name/value='Status']",
          "status",
          StatusCluster.class,
          this);
  ...
  public SelectAqlField<StatusDiagnostischeSicherheitChoice> DIAGNOSTISCHE_SICHERHEIT =
      new AqlFieldImp<StatusDiagnostischeSicherheitChoice>(
          ProblemDiganoseCoronovirusEvaluation.class,
          "/data[at0001]/items[at0073]/value",
          "diagnostischeSicherheit",
          StatusDiagnostischeSicherheitChoice.class,
          this);

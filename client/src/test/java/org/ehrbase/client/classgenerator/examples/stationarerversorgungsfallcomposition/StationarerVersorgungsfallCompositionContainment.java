...
public class StationarerVersorgungsfallCompositionContainment extends Containment {
  ...
  public SelectAqlField<FalltypDefiningCode> FALLTYP_DEFINING_CODE = new AqlFieldImp<FalltypDefiningCode>(StationarerVersorgungsfallComposition.class, "/context/other_context[at0001]/items[at0005]/value|defining_code", "falltypDefiningCode", FalltypDefiningCode.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(StationarerVersorgungsfallComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

  public SelectAqlField<AufnahmedatenAdminEntry> AUFNAHMEDATEN = new AqlFieldImp<AufnahmedatenAdminEntry>(StationarerVersorgungsfallComposition.class, "/content[openEHR-EHR-ADMIN_ENTRY.admission.v0]", "aufnahmedaten", AufnahmedatenAdminEntry.class, this);
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(StationarerVersorgungsfallComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);

...
public class DetailsZumBettClusterContainment extends Containment {
  ...
  public SelectAqlField<String> GERATENAME_VALUE = new AqlFieldImp<String>(DetailsZumBettCluster.class, "/items[at0001]/value|value", "geratenameValue", String.class, this);

  public SelectAqlField<String> GERATETYP_VALUE = new AqlFieldImp<String>(DetailsZumBettCluster.class, "/items[at0003]/value|value", "geratetypValue", String.class, this);
  ...
  public ListSelectAqlField<Cluster> GERATEVERWALTUNG = new ListAqlFieldImp<Cluster>(DetailsZumBettCluster.class, "/items[at0019]", "gerateverwaltung", Cluster.class, this);

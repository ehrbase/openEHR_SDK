...
@Generated(
    ...
    date = "2020-12-09T15:54:55.414273+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: null")
public class DeviceDetailsTrainingSampleCluster implements LocatableEntity {
  /** Encounter (training sample)/context/Admin detail/Device details (training sample)/value */
  @Path("/items[at0001]/value|value")
  private String nameValue;

  /**
   * Encounter (training sample)/context/Tree/Admin detail/Device details (training
  ...
  /**
   * Encounter (training sample)/context/Admin detail/Device details (training sample)/Manufacturer
   * details/value
   */
  ...
  /**
   * Encounter (training sample)/context/Admin detail/Device details (training
   * sample)/Servicing/value
   */

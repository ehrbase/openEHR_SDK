...
public class KeyCovidSymptomCluster implements LocatableEntity {
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Key Covid symptom/Symptom/Sign
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Key Covid symptom/Structured
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Key Covid symptom/Specific
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Key Covid symptom/Previous
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Key Covid symptom/Associated

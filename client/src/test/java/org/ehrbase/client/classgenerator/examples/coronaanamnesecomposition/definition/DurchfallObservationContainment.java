...
public class DurchfallObservationContainment extends Containment {
  ...
  public SelectAqlField<VorhandenDefiningcode> VORHANDEN_DEFININGCODE = new AqlFieldImp<VorhandenDefiningcode>(DurchfallObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0022]/items[at0005]/value|defining_code", "vorhandenDefiningcode", VorhandenDefiningcode.class, this);
  ...
  public ListSelectAqlField<Cluster> ANZEICHEN = new ListAqlFieldImp<Cluster>(DurchfallObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0022]/items[at0026]", "anzeichen", Cluster.class, this);

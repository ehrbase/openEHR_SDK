...
public class HeiserkeitObservationContainment extends Containment {
  ...
  public SelectAqlField<VorhandenDefiningCode> VORHANDEN_DEFINING_CODE = new AqlFieldImp<VorhandenDefiningCode>(HeiserkeitObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0022]/items[at0005]/value|defining_code", "vorhandenDefiningCode", VorhandenDefiningCode.class, this);

  public ListSelectAqlField<Cluster> DETAILLIERTE_ANGABEN_ZUM_SYMPTOM_ANZEICHEN = new ListAqlFieldImp<Cluster>(HeiserkeitObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0022]/items[at0026]", "detaillierteAngabenZumSymptomAnzeichen", Cluster.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(HeiserkeitObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

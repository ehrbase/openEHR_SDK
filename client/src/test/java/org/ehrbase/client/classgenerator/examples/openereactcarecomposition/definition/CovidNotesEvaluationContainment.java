...
public class CovidNotesEvaluationContainment extends Containment {
  public SelectAqlField<CovidNotesEvaluation> COVID_NOTES_EVALUATION =
  ...
  public SelectAqlField<PartyProxy> SUBJECT =
      new AqlFieldImp<PartyProxy>(
          CovidNotesEvaluation.class, "/subject", "subject", PartyProxy.class, this);

  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          CovidNotesEvaluation.class, "/language", "language", Language.class, this);

...
public class TestAllTypesAdminEntryContainment extends Containment {
  public SelectAqlField<TestAllTypesAdminEntry> TEST_ALL_TYPES_ADMIN_ENTRY = new AqlFieldImp<TestAllTypesAdminEntry>(TestAllTypesAdminEntry.class, "", "TestAllTypesAdminEntry", TestAllTypesAdminEntry.class, this);
  ...
  public SelectAqlField<Long> COUNT3_MAGNITUDE = new AqlFieldImp<Long>(TestAllTypesAdminEntry.class, "/data[at0001]/item[at0002]/value|magnitude", "count3Magnitude", Long.class, this);

...
public class DiagnosedetailsClusterContainment extends Containment {
  ...
  public SelectAqlField<String> BEGRUNDUNG_VON_AUSNAHMEN_VALUE = new AqlFieldImp<String>(DiagnosedetailsCluster.class, "/items[at0001]/value|value", "begrundungVonAusnahmenValue", String.class, this);

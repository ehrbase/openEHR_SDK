...
public class PulseOximetryObservationContainment extends Containment {
  ...
  public SelectAqlField<DvProportion> SPO = new AqlFieldImp<DvProportion>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0006]/value", "spo", DvProportion.class, this);

  public ListSelectAqlField<Cluster> WAVEFORM = new ListAqlFieldImp<Cluster>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0054]", "waveform", Cluster.class, this);

  public ListSelectAqlField<Cluster> MULTIMEDIA_IMAGE = new ListAqlFieldImp<Cluster>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0060]", "multimediaImage", Cluster.class, this);

  public SelectAqlField<Cluster> EXERTION = new AqlFieldImp<Cluster>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/state[at0014]/items[at0034]", "exertion", Cluster.class, this);

  public SelectAqlField<Cluster> INSPIRED_OXYGEN = new AqlFieldImp<Cluster>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/state[at0014]/items[at0015]", "inspiredOxygen", Cluster.class, this);

  public SelectAqlField<TemporalAccessor> TIME_VALUE = new AqlFieldImp<TemporalAccessor>(PulseOximetryObservation.class, "/data[at0001]/events[at0002]/time|value", "timeValue", TemporalAccessor.class, this);

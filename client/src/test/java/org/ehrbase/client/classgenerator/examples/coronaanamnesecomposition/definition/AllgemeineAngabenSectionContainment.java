...
public class AllgemeineAngabenSectionContainment extends Containment {
  ...
  public SelectAqlField<AndereAktuelleErkrankungenObservation> ANDERE_AKTUELLE_ERKRANKUNGEN = new AqlFieldImp<AndereAktuelleErkrankungenObservation>(AllgemeineAngabenSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "andereAktuelleErkrankungen", AndereAktuelleErkrankungenObservation.class, this);

  public SelectAqlField<ChronischeErkrankungenObservation> CHRONISCHE_ERKRANKUNGEN = new AqlFieldImp<ChronischeErkrankungenObservation>(AllgemeineAngabenSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "chronischeErkrankungen", ChronischeErkrankungenObservation.class, this);

  public ListSelectAqlField<ProblemDiagnoseEvaluation> PROBLEM_DIAGNOSE = new ListAqlFieldImp<ProblemDiagnoseEvaluation>(AllgemeineAngabenSection.class, "/items[openEHR-EHR-EVALUATION.problem_diagnosis.v1]", "problemDiagnose", ProblemDiagnoseEvaluation.class, this);
  ...
  public SelectAqlField<GesundheitsbezogenerBerufEvaluation> GESUNDHEITSBEZOGENER_BERUF = new AqlFieldImp<GesundheitsbezogenerBerufEvaluation>(AllgemeineAngabenSection.class, "/items[openEHR-EHR-EVALUATION.occupation_summary.v1]", "gesundheitsbezogenerBeruf", GesundheitsbezogenerBerufEvaluation.class, this);

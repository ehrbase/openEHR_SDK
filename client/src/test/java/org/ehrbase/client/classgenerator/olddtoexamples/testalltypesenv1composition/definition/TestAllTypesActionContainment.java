...
public class TestAllTypesActionContainment extends Containment {
  ...
  public SelectAqlField<PlannedDefiningcode2> PLANNED_DEFININGCODE_CURRENT_STATE = new AqlFieldImp<PlannedDefiningcode2>(TestAllTypesAction.class, "/ism_transition[at0003]/current_state|defining_code", "plannedDefiningcodeCurrentState", PlannedDefiningcode2.class, this);

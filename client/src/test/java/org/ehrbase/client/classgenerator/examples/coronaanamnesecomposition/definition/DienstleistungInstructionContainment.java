...
public class DienstleistungInstructionContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> ERWEITERUNG = new ListAqlFieldImp<Cluster>(DienstleistungInstruction.class, "/protocol[at0008]/items[at0112]", "erweiterung", Cluster.class, this);
  ...
  public SelectAqlField<PartyProxy> SUBJECT = new AqlFieldImp<PartyProxy>(DienstleistungInstruction.class, "/subject", "subject", PartyProxy.class, this);

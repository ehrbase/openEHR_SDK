...
public class DiagnoseCompositionContainment extends Containment {
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(DiagnoseComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(DiagnoseComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);

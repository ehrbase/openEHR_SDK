...
public class EhrbaseMultiOccurrenceDeV1CompositionContainment extends Containment {
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(EhrbaseMultiOccurrenceDeV1Composition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(EhrbaseMultiOccurrenceDeV1Composition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);

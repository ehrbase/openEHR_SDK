...
public class TestAllTypesEnV1CompositionContainment extends Containment {
  ...
  public SelectAqlField<TemporalAccessor> END_TIME_VALUE = new AqlFieldImp<TemporalAccessor>(TestAllTypesEnV1Composition.class, "/context/end_time|value", "endTimeValue", TemporalAccessor.class, this);

  public ListSelectAqlField<Participation> PARTICIPATIONS = new ListAqlFieldImp<Participation>(TestAllTypesEnV1Composition.class, "/context/participations", "participations", Participation.class, this);
  ...
  public SelectAqlField<ContextCodedTextDefiningcode> CONTEXT_CODED_TEXT_DEFININGCODE = new AqlFieldImp<ContextCodedTextDefiningcode>(TestAllTypesEnV1Composition.class, "/context/other_context[at0004]/item[at0005]/value|defining_code", "contextCodedTextDefiningcode", ContextCodedTextDefiningcode.class, this);

  public SelectAqlField<TemporalAccessor> START_TIME_VALUE = new AqlFieldImp<TemporalAccessor>(TestAllTypesEnV1Composition.class, "/context/start_time|value", "startTimeValue", TemporalAccessor.class, this);

  public ListSelectAqlField<TestAllTypesEvaluation> TEST_ALL_TYPES = new ListAqlFieldImp<TestAllTypesEvaluation>(TestAllTypesEnV1Composition.class, "/content[openEHR-EHR-EVALUATION.test_all_types.v1]", "testAllTypes", TestAllTypesEvaluation.class, this);

  public ListSelectAqlField<TestAllTypesSection> TEST_ALL_TYPES_CONTENT_OPENEHR_EHR_SECTION_TEST_ALL_TYPES_V1 = new ListAqlFieldImp<TestAllTypesSection>(TestAllTypesEnV1Composition.class, "/content[openEHR-EHR-SECTION.test_all_types.v1]", "testAllTypesContentOpenehrEhrSectionTestAllTypesV1", TestAllTypesSection.class, this);
  ...
  public SelectAqlField<String> LOCATION = new AqlFieldImp<String>(TestAllTypesEnV1Composition.class, "/context/location", "location", String.class, this);

  public SelectAqlField<CategoryDefiningcode> CATEGORY_DEFININGCODE = new AqlFieldImp<CategoryDefiningcode>(TestAllTypesEnV1Composition.class, "/category|defining_code", "categoryDefiningcode", CategoryDefiningcode.class, this);

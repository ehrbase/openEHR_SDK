...
public class AbteilungsfallClusterContainment extends Containment {
  ...
  public SelectAqlField<String> ZUGEHORIGE_ABTEILUNGSFALL_KENNUNG_VALUE = new AqlFieldImp<String>(AbteilungsfallCluster.class, "/items[at0001]/value|value", "zugehorigeAbteilungsfallKennungValue", String.class, this);

...
public class MedicationEvaluationContainment extends Containment {
  public SelectAqlField<MedicationEvaluation> MEDICATION_EVALUATION =
  ...
  public SelectAqlField<PartyProxy> SUBJECT =
      new AqlFieldImp<PartyProxy>(
          MedicationEvaluation.class, "/subject", "subject", PartyProxy.class, this);

  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          MedicationEvaluation.class, "/language", "language", Language.class, this);

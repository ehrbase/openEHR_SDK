...
public enum PresenceDefiningcodeCareHomeHasSuspectedConfirmedCovid19 implements EnumValueSet {
  ...
  PresenceDefiningcodeCareHomeHasSuspectedConfirmedCovid19(String value, String description,

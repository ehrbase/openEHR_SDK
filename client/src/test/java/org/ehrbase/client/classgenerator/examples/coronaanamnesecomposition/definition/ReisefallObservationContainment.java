...
public class ReisefallObservationContainment extends Containment {
  ...
  public ListSelectAqlField<ReisefallBeliebigesIntervallereignisIntervalEvent> BELIEBIGES_INTERVALLEREIGNIS = new ListAqlFieldImp<ReisefallBeliebigesIntervallereignisIntervalEvent>(ReisefallObservation.class, "/data[at0001]/events[at0002]", "beliebigesIntervallereignis", ReisefallBeliebigesIntervallereignisIntervalEvent.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(ReisefallObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

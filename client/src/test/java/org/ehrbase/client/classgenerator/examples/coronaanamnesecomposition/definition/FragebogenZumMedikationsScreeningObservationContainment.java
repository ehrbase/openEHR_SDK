...
public class FragebogenZumMedikationsScreeningObservationContainment extends Containment {
  ...
  public SelectAqlField<MedikamentenklasseInVerwendungDefiningcode> MEDIKAMENTENKLASSE_IN_VERWENDUNG_DEFININGCODE = new AqlFieldImp<MedikamentenklasseInVerwendungDefiningcode>(FragebogenZumMedikationsScreeningObservation.class, "/data[at0022]/events[at0023]/data[at0001]/items[at0026]/items[at0003]/value|defining_code", "medikamentenklasseInVerwendungDefiningcode", MedikamentenklasseInVerwendungDefiningcode.class, this);
  ...
  public SelectAqlField<CodePhrase> MEDIKAMENTE_IN_VERWENDUNG_DEFININGCODE = new AqlFieldImp<CodePhrase>(FragebogenZumMedikationsScreeningObservation.class, "/data[at0022]/events[at0023]/data[at0001]/items[at0027]/value|defining_code", "medikamenteInVerwendungDefiningcode", CodePhrase.class, this);

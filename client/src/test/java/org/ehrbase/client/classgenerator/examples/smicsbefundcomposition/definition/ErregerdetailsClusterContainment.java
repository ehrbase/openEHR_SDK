...
public class ErregerdetailsClusterContainment extends Containment {
  ...
  public SelectAqlField<MreKlasseDefiningCode> MRE_KLASSE_DEFINING_CODE = new AqlFieldImp<MreKlasseDefiningCode>(ErregerdetailsCluster.class, "/items[at0018]/value|defining_code", "mreKlasseDefiningCode", MreKlasseDefiningCode.class, this);

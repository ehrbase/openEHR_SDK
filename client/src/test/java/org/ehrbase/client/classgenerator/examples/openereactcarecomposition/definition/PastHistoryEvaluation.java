...
@Generated(
    ...
    date = "2020-12-09T11:37:51.539762200+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: null"
)
public class PastHistoryEvaluation implements EntryEntity {
  /**
   * open_eREACT-Care/Background/Past history/Synopsis
   */
  @Path("/data[at0001]/items[at0002]/value|value")
  private String synopsisValue;

  /**
   * open_eREACT-Care/Background/Past history/Extension
   */
  @Path("/protocol[at0003]/items[at0004]")
  private List<Cluster> extension;

  /**
   * open_eREACT-Care/Background/Past history/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * open_eREACT-Care/Background/Past history/language
   */
  @Path("/language")
  private Language language;

  /**
   * open_eREACT-Care/Background/Past history/feeder_audit
   */
  @Path("/feeder_audit")

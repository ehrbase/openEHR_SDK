...
public enum RedFlagAcuteDefiningCode implements EnumValueSet {
  ...
  NOT_PASSED_URINE_IN18_HOURS05ML_KG_HR_IF_CATHETERISED("Not passed urine in 18 hours (<0.5ml/kg/hr if catheterised)", "Not passed urine in 18 hours (<0.5ml/kg/hr if catheterised)", "local", "at0082"),
  ...
  NON_BLANCHING_RASH_MOTTLED_ASHEN_CYANOTIC("Non-blanching rash / mottled / ashen / cyanotic", "Non-blanching rash / mottled / ashen / cyanotic", "local", "at0079");

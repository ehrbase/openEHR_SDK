...
public class VirologischerBefundCompositionContainment extends Containment {
  ...
  public SelectAqlField<BefundObservation> BEFUND = new AqlFieldImp<BefundObservation>(VirologischerBefundComposition.class, "/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Befund']", "befund", BefundObservation.class, this);

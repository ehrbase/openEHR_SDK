...
public class BackgroundSectionContainment extends Containment {
  ...
  public SelectAqlField<HeightObservation> HEIGHT = new AqlFieldImp<HeightObservation>(BackgroundSection.class, "/items[openEHR-EHR-OBSERVATION.height.v2]", "height", HeightObservation.class, this);

  public SelectAqlField<WeightObservation> WEIGHT = new AqlFieldImp<WeightObservation>(BackgroundSection.class, "/items[openEHR-EHR-OBSERVATION.body_weight.v2]", "weight", WeightObservation.class, this);

  public SelectAqlField<FrailtyObservation> FRAILTY = new AqlFieldImp<FrailtyObservation>(BackgroundSection.class, "/items[openEHR-EHR-OBSERVATION.clinical_frailty_scale.v1]", "frailty", FrailtyObservation.class, this);

  public SelectAqlField<PastHistoryEvaluation> PAST_HISTORY = new AqlFieldImp<PastHistoryEvaluation>(BackgroundSection.class, "/items[openEHR-EHR-EVALUATION.clinical_synopsis.v1]", "pastHistory", PastHistoryEvaluation.class, this);

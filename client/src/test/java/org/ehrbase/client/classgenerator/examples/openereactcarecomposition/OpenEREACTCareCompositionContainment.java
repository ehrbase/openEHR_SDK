...
public class OpenEREACTCareCompositionContainment extends Containment {
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(OpenEREACTCareComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

  public SelectAqlField<SituationSection> SITUATION = new AqlFieldImp<SituationSection>(OpenEREACTCareComposition.class, "/content[openEHR-EHR-SECTION.adhoc.v1]", "situation", SituationSection.class, this);

  public SelectAqlField<BackgroundSection> BACKGROUND = new AqlFieldImp<BackgroundSection>(OpenEREACTCareComposition.class, "/content[openEHR-EHR-SECTION.adhoc.v1]", "background", BackgroundSection.class, this);

  public SelectAqlField<AssessmentSection> ASSESSMENT = new AqlFieldImp<AssessmentSection>(OpenEREACTCareComposition.class, "/content[openEHR-EHR-SECTION.adhoc.v1]", "assessment", AssessmentSection.class, this);

  public SelectAqlField<ResponseSection> RESPONSE = new AqlFieldImp<ResponseSection>(OpenEREACTCareComposition.class, "/content[openEHR-EHR-SECTION.adhoc.v1]", "response", ResponseSection.class, this);

...
public class TestAllTypesActionContainment extends Containment {
  ...
  public SelectAqlField<PlannedDefiningcode> PLANNED_DEFININGCODE = new AqlFieldImp<PlannedDefiningcode>(TestAllTypesAction.class, "/ism_transition[at0003]/careflow_step|defining_code", "plannedDefiningcode", PlannedDefiningcode.class, this);
  ...
  public SelectAqlField<org.ehrbase.client.classgenerator.examples.shareddefinition.PlannedDefiningcode> PLANNED_DEFININGCODE_CURRENT_STATE = new AqlFieldImp<org.ehrbase.client.classgenerator.examples.shareddefinition.PlannedDefiningcode>(TestAllTypesAction.class, "/ism_transition[at0003]/current_state|defining_code", "plannedDefiningcodeCurrentState", org.ehrbase.client.classgenerator.examples.shareddefinition.PlannedDefiningcode.class, this);

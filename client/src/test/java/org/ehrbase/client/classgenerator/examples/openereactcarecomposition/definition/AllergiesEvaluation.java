...
public class AllergiesEvaluation implements EntryEntity {
  /**
   * Path: open_eREACT-Care/Background/Allergies/Synopsis Description: The summary, assessment,
  ...
  /**
   * Path: open_eREACT-Care/Background/Allergies/Extension Description: Additional information

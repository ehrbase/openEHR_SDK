...
public class StandortClusterContainment extends Containment {
  ...
  public SelectAqlField<StandortschlusselDefiningCode> STANDORTSCHLUSSEL_DEFINING_CODE = new AqlFieldImp<StandortschlusselDefiningCode>(StandortCluster.class, "/items[at0048]/value|defining_code", "standortschlusselDefiningCode", StandortschlusselDefiningCode.class, this);

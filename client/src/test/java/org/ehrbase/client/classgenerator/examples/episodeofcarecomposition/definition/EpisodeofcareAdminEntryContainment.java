...
public class EpisodeofcareAdminEntryContainment extends Containment {
  ...
  public SelectAqlField<StatusDefiningCode> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode>(EpisodeofcareAdminEntry.class, "/data[at0001]/items[at0003]/value|defining_code", "statusDefiningCode", StatusDefiningCode.class, this);
  ...
  public SelectAqlField<TemporalAccessor> UPPER_VALUE = new AqlFieldImp<TemporalAccessor>(EpisodeofcareAdminEntry.class, "/data[at0001]/items[at0014]/value/upper|value", "upperValue", TemporalAccessor.class, this);

  public SelectAqlField<TemporalAccessor> LOWER_VALUE = new AqlFieldImp<TemporalAccessor>(EpisodeofcareAdminEntry.class, "/data[at0001]/items[at0014]/value/lower|value", "lowerValue", TemporalAccessor.class, this);

  public SelectAqlField<Boolean> LOWER_INCLUDED = new AqlFieldImp<Boolean>(EpisodeofcareAdminEntry.class, "/data[at0001]/items[at0014]/value/lower_included", "lowerIncluded", Boolean.class, this);

  public SelectAqlField<Boolean> UPPER_INCLUDED = new AqlFieldImp<Boolean>(EpisodeofcareAdminEntry.class, "/data[at0001]/items[at0014]/value/upper_included", "upperIncluded", Boolean.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(EpisodeofcareAdminEntry.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

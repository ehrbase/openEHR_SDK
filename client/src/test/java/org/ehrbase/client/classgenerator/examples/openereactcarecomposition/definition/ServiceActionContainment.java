...
public class ServiceActionContainment extends Containment {
  ...
  public SelectAqlField<ServicePlannedDefiningcode2> SERVICE_PLANNED_DEFININGCODE_CURRENT_STATE = new AqlFieldImp<ServicePlannedDefiningcode2>(ServiceAction.class, "/ism_transition[at0002]/current_state|defining_code", "servicePlannedDefiningcodeCurrentState", ServicePlannedDefiningcode2.class, this);

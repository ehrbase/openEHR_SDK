...
public class KoerpertemperaturObservationContainment extends Containment {
  ...
  public ListSelectAqlField<KoerpertemperaturStoerfaktorenElement> STOERFAKTOREN = new ListAqlFieldImp<KoerpertemperaturStoerfaktorenElement>(KoerpertemperaturObservation.class, "/data[at0002]/events[at0003]/state[at0029]/items[at0066]", "stoerfaktoren", KoerpertemperaturStoerfaktorenElement.class, this);

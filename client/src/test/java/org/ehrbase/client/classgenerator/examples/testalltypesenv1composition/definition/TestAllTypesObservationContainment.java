...
public class TestAllTypesObservationContainment extends Containment {
  ...
  public SelectAqlField<DvCodedText> CODED_TEXT =
  ...
  public SelectAqlField<DvCodedText> CODED_TEXT_TERMINOLOGY =
      new AqlFieldImp<DvCodedText>(
          TestAllTypesObservation.class,
  ...
  public SelectAqlField<TemporalAccessor> ARBOL_TIME_VALUE =
      new AqlFieldImp<TemporalAccessor>(
          TestAllTypesObservation.class,
  ...
  public SelectAqlField<TemporalAccessor> CUALQUIER_EVENTO_TIME_VALUE =
      new AqlFieldImp<TemporalAccessor>(
          TestAllTypesObservation.class,

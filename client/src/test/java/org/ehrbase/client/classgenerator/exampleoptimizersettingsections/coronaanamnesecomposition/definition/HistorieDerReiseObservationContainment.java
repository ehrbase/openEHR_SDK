...
public class HistorieDerReiseObservationContainment extends Containment {
  ...
  public SelectAqlField<AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFuerCoronainfektionOderKonta_> AUFENTHALT_IN_DEN_LETZTEN14_TAGE_IN_EINEM_DER_RISIKOGEBIETE_FUER_CORONAINFEKTION_ODER_KONTAKT_ZU_MENSCHEN_DIE_DORT_WAREN_DEFINING_CODE = new AqlFieldImp<AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFuerCoronainfektionOderKonta_>(HistorieDerReiseObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0111]/value|defining_code", "aufenthaltInDenLetzten14TageInEinemDerRisikogebieteFuerCoronainfektionOderKontaktZuMenschenDieDortWarenDefiningCode", AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFuerCoronainfektionOderKonta_.class, this);

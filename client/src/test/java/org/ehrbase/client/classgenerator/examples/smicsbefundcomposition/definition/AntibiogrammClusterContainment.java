...
public class AntibiogrammClusterContainment extends Containment {
  ...
  public ListSelectAqlField<LaboranalytResultatCluster> LABORANALYT_RESULTAT = new ListAqlFieldImp<LaboranalytResultatCluster>(AntibiogrammCluster.class, "/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "laboranalytResultat", LaboranalytResultatCluster.class, this);

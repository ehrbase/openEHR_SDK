...
public class WohnsituationEvaluationContainment extends Containment {
  ...
  public SelectAqlField<String> BESCHREIBUNG_VALUE = new AqlFieldImp<String>(WohnsituationEvaluation.class, "/data[at0001]/items[at0003]/value|value", "beschreibungValue", String.class, this);

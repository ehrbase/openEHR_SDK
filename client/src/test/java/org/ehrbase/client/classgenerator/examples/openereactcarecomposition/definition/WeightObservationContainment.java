...
public class WeightObservationContainment extends Containment {
  ...
  public SelectAqlField<Double> WEIGHT_MAGNITUDE = new AqlFieldImp<Double>(WeightObservation.class, "/data[at0002]/events[at0003]/data[at0001]/items[at0004]/value|magnitude", "weightMagnitude", Double.class, this);

  public SelectAqlField<String> WEIGHT_UNITS = new AqlFieldImp<String>(WeightObservation.class, "/data[at0002]/events[at0003]/data[at0001]/items[at0004]/value|units", "weightUnits", String.class, this);

  public SelectAqlField<ItemTree> STATE_STRUCTURE = new AqlFieldImp<ItemTree>(WeightObservation.class, "/data[at0002]/events[at0003]/state[at0008]", "stateStructure", ItemTree.class, this);

  public SelectAqlField<TemporalAccessor> TIME_VALUE = new AqlFieldImp<TemporalAccessor>(WeightObservation.class, "/data[at0002]/events[at0003]/time|value", "timeValue", TemporalAccessor.class, this);

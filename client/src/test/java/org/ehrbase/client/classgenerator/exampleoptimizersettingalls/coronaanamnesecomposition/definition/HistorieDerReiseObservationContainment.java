...
public class HistorieDerReiseObservationContainment extends Containment {
  ...
  public SelectAqlField<AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFurCoronainfektionOderKontak_> AUFENTHALT_IN_DEN_LETZTEN14_TAGE_IN_EINEM_DER_RISIKOGEBIETE_FUR_CORONAINFEKTION_ODER_KONTAKT_ZU_MENSCHEN_DIE_DORT_WAREN_DEFINING_CODE = new AqlFieldImp<AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFurCoronainfektionOderKontak_>(HistorieDerReiseObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0111]/value|defining_code", "aufenthaltInDenLetzten14TageInEinemDerRisikogebieteFurCoronainfektionOderKontaktZuMenschenDieDortWarenDefiningCode", AufenthaltInDenLetzten14TageInEinemDerRisikogebieteFurCoronainfektionOderKontak_.class, this);

  public SelectAqlField<String> STANDORTBESCHREIBUNG_VALUE = new AqlFieldImp<String>(HistorieDerReiseObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0134]/items[openEHR-EHR-CLUSTER.location.v1]/items[at0046]/value|value", "standortbeschreibungValue", String.class, this);

  public ListSelectAqlField<Cluster> DETAILS = new ListAqlFieldImp<Cluster>(HistorieDerReiseObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0134]/items[openEHR-EHR-CLUSTER.location.v1]/items[at0047]", "details", Cluster.class, this);

...
public class EmpfangerstandortCluster implements LocatableEntity {
  /**
   * Path: Virologischer Befund/Befund/Empfängerstandort/Standorttyp Description: Kategorisierung
   * des Standorttyps, z.B. Klinik, zu Hause.
   */
  @Path("/items[at0040]/value|value")
  private String standorttypValue;

  /**
   * Path: Virologischer Befund/Befund/Empfängerstandort/Standortbeschreibung Description: Das Feld
  ...
  /**
   * Path: Virologischer Befund/Befund/Empfängerstandort/Standortschlüssel Description: Kodierung
   * des Standortes, z.B. der Fachabteilungsschlüssel (z. B. 2000 Thoraxchirurgie).
   */
  @Path("/items[at0048]/value|value")
  private String standortschlusselValue;

  /**
   * Path: Virologischer Befund/Befund/Empfängerstandort/Details Description: Für die Erfassung
   * weiterer Angaben über das Bett oder der Adresse. Verwenden Sie dazu den Archetyp CLUSTER.device
   * oder CLUSTER.address.
   */
  @Path("/items[at0047]")

...
public class LaboranalytResultatClusterContainment extends Containment {
  ...
  public SelectAqlField<AntibiotikumDefiningCode> ANTIBIOTIKUM_DEFINING_CODE = new AqlFieldImp<AntibiotikumDefiningCode>(LaboranalytResultatCluster.class, "/items[at0024]/value|defining_code", "antibiotikumDefiningCode", AntibiotikumDefiningCode.class, this);

  public SelectAqlField<Double> MINIMALE_HEMMKONZENTRATION_MAGNITUDE = new AqlFieldImp<Double>(LaboranalytResultatCluster.class, "/items[at0001]/value|magnitude", "minimaleHemmkonzentrationMagnitude", Double.class, this);

  public SelectAqlField<String> MINIMALE_HEMMKONZENTRATION_UNITS = new AqlFieldImp<String>(LaboranalytResultatCluster.class, "/items[at0001]/value|units", "minimaleHemmkonzentrationUnits", String.class, this);

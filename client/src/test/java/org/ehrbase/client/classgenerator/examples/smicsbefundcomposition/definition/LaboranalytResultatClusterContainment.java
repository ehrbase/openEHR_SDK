...
public class LaboranalytResultatClusterContainment extends Containment {
  ...
  public SelectAqlField<AntibiotikumDefiningcode> ANTIBIOTIKUM_DEFININGCODE = new AqlFieldImp<AntibiotikumDefiningcode>(LaboranalytResultatCluster.class, "/items[at0024]/value|defining_code", "antibiotikumDefiningcode", AntibiotikumDefiningcode.class, this);

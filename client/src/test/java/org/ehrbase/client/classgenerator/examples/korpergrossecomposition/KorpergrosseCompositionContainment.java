package org.ehrbase.client.classgenerator.examples.korpergrossecomposition;
...
import org.ehrbase.client.classgenerator.examples.korpergrossecomposition.definition.StatusDefiningCode;
...
public class KorpergrosseCompositionContainment extends Containment {
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(KorpergrosseComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);
  ...
  public SelectAqlField<StatusDefiningCode> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode>(KorpergrosseComposition.class, "/context/other_context[at0001]/items[at0004]/value|defining_code", "statusDefiningCode", StatusDefiningCode.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(KorpergrosseComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

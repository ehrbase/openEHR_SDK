...
public class AcvpuScaleObservationContainment extends Containment {
  ...
  public SelectAqlField<AcvpuDefiningCode> ACVPU_DEFINING_CODE = new AqlFieldImp<AcvpuDefiningCode>(AcvpuScaleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]/value|defining_code", "acvpuDefiningCode", AcvpuDefiningCode.class, this);

  public SelectAqlField<ItemTree> TREE = new AqlFieldImp<ItemTree>(AcvpuScaleObservation.class, "/data[at0001]/events[at0002]/state[at0013]", "tree", ItemTree.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(AcvpuScaleObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

...
public class FirstSymptomsCluster implements LocatableEntity {
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Symptom/Sign
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Structured body
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Date of onset
   * of first symptoms Description: The onset for this episode of the symptom or sign.
   */
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Specific
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Previous
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/First symptoms/Associated

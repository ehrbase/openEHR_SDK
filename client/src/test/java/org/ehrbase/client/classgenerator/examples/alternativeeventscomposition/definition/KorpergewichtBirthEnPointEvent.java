...
public class KorpergewichtBirthEnPointEvent implements PointEventEntity {
  /** Path: Bericht/Körpergewicht/*Birth(en)/Gewicht Description: Das Gewicht eines Individuums. */
  ...
  /**
   * Path: Bericht/Körpergewicht/*Birth(en)/*Comment(en) Description: *Additional narrative about
   * the measurement of Body weight, not captured in other fields.(en)
   */
  @Path("/data[at0001]/items[at0024]/value|value")
  private String commentEnValue;

  /**
   * Path: Bericht/Körpergewicht/*Birth(en)/*State of dress(en) Description: *Description of the

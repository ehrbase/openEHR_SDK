...
public class SauerstoffsattigungClusterContainment extends Containment {
  ...
  public SelectAqlField<UntersuchterAnalytDefiningCode4> UNTERSUCHTER_ANALYT_DEFINING_CODE = new AqlFieldImp<UntersuchterAnalytDefiningCode4>(SauerstoffsattigungCluster.class, "/items[at0024]/value|defining_code", "untersuchterAnalytDefiningCode", UntersuchterAnalytDefiningCode4.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(SauerstoffsattigungCluster.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

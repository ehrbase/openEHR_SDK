...
public class News2SectionContainment extends Containment {
    ...
    public SelectAqlField<AcvpuScaleObservation> ACVPU_SCALE = new AqlFieldImp<AcvpuScaleObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.acvpu.v0]", "acvpuScale", AcvpuScaleObservation.class, this);
    ...
    public SelectAqlField<TemperatureObservation> TEMPERATURE = new AqlFieldImp<TemperatureObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.body_temperature.v1 and name/value='Temperature']", "temperature", TemperatureObservation.class, this);

    public SelectAqlField<RespirationsObservation> RESPIRATIONS = new AqlFieldImp<RespirationsObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.respiration.v1]", "respirations", RespirationsObservation.class, this);

    public SelectAqlField<PulseObservation> PULSE = new AqlFieldImp<PulseObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.pulse.v1 and name/value='Pulse']", "pulse", PulseObservation.class, this);

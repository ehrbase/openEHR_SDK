...
public class News2SectionContainment extends Containment {
  ...
  public SelectAqlField<TemperatureObservation> TEMPERATURE = new AqlFieldImp<TemperatureObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.body_temperature.v1]", "temperature", TemperatureObservation.class, this);
  ...
  public SelectAqlField<PulseObservation> PULSE = new AqlFieldImp<PulseObservation>(News2Section.class, "/items[openEHR-EHR-OBSERVATION.pulse.v1]", "pulse", PulseObservation.class, this);

...
public class SymptomeSectionContainment extends Containment {
  ...
  public SelectAqlField<HustenObservation> HUSTEN = new AqlFieldImp<HustenObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "husten", HustenObservation.class, this);

  public SelectAqlField<SchnupfenObservation> SCHNUPFEN = new AqlFieldImp<SchnupfenObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "schnupfen", SchnupfenObservation.class, this);

  public SelectAqlField<HeiserkeitObservation> HEISERKEIT = new AqlFieldImp<HeiserkeitObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "heiserkeit", HeiserkeitObservation.class, this);

  public SelectAqlField<FieberOderErhohteKorpertemperaturObservation> FIEBER_ODER_ERHOHTE_KORPERTEMPERATUR = new AqlFieldImp<FieberOderErhohteKorpertemperaturObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "fieberOderErhohteKorpertemperatur", FieberOderErhohteKorpertemperaturObservation.class, this);
  ...
  public SelectAqlField<GestorterGeruchssinnObservation> GESTORTER_GERUCHSSINN = new AqlFieldImp<GestorterGeruchssinnObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "gestorterGeruchssinn", GestorterGeruchssinnObservation.class, this);

  public SelectAqlField<GestorterGeschmackssinnObservation> GESTORTER_GESCHMACKSSINN = new AqlFieldImp<GestorterGeschmackssinnObservation>(SymptomeSection.class, "/items[openEHR-EHR-OBSERVATION.symptom_sign_screening.v0]", "gestorterGeschmackssinn", GestorterGeschmackssinnObservation.class, this);

...
public class GECCOSerologischerBefundComposition implements CompositionEntity {
   ...
   */
  @Path(
      "/context/other_context[at0001 and name/value='Tree']/items[at0005 and name/value='Kategorie']")
   ...
   */
  @Path(
      "/context/other_context[at0001 and name/value='Tree']/items[at0005 and name/value='Kategorie (LOINC)']")

...
public class KorpertemperaturObservationContainment extends Containment {
  ...
  public SelectAqlField<Double> TEMPERATUR_MAGNITUDE = new AqlFieldImp<Double>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/data[at0001]/items[at0004]/value|magnitude", "temperaturMagnitude", Double.class, this);

  public SelectAqlField<String> TEMPERATUR_UNITS = new AqlFieldImp<String>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/data[at0001]/items[at0004]/value|units", "temperaturUnits", String.class, this);

  public ListSelectAqlField<KorpertemperaturStorfaktorenElement> STORFAKTOREN = new ListAqlFieldImp<KorpertemperaturStorfaktorenElement>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/state[at0029]/items[at0066]", "storfaktoren", KorpertemperaturStorfaktorenElement.class, this);

  public ListSelectAqlField<Cluster> UMGEBUNGSBEDINGUNGEN = new ListAqlFieldImp<Cluster>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/state[at0029]/items[at0056]", "umgebungsbedingungen", Cluster.class, this);

  public SelectAqlField<Cluster> BETATIGUNG = new AqlFieldImp<Cluster>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/state[at0029]/items[at0057]", "betatigung", Cluster.class, this);

  public SelectAqlField<TemporalAccessor> TIME_VALUE = new AqlFieldImp<TemporalAccessor>(KorpertemperaturObservation.class, "/data[at0002]/events[at0003]/time|value", "timeValue", TemporalAccessor.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(KorpertemperaturObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

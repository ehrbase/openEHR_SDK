...
public class DurchfallObservationContainment extends Containment {
  public SelectAqlField<DurchfallObservation> DURCHFALL_OBSERVATION =
  ...
  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          DurchfallObservation.class, "/language", "language", Language.class, this);
  ...
  public SelectAqlField<PartyProxy> SUBJECT =
      new AqlFieldImp<PartyProxy>(
          DurchfallObservation.class, "/subject", "subject", PartyProxy.class, this);

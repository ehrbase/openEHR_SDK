...
public class SchnupfenObservationContainment extends Containment {
  public SelectAqlField<SchnupfenObservation> SCHNUPFEN_OBSERVATION =
  ...
  public SelectAqlField<PartyProxy> SUBJECT =
      new AqlFieldImp<PartyProxy>(
          SchnupfenObservation.class, "/subject", "subject", PartyProxy.class, this);

  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          SchnupfenObservation.class, "/language", "language", Language.class, this);

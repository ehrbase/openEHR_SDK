...
public class SauerstoffsattigungCluster implements LocatableEntity {
  /**
   * Path: Befund der Blutgasanalyse/Laborergebnis/Jedes Ereignis/Sauerstoffsättigung/untersuchter
   * Analyt Description: Die Bezeichnung des Analyt-Resultats
   */
   ...
   * Ereignis/Sauerstoffsättigung/Analyt-Resultat Description: (Mess-)Wert des Analyt-Resultats.
   */
  ...
  /**
   * Path: Befund der Blutgasanalyse/Laborergebnis/Jedes
   * Ereignis/Sauerstoffsättigung/Analyseergebnis-Details Description: Weitere Details zu einem
   * einzelnen Ergebnis.
   */
  @Path("/items[at0014]")
  ...
  /**
   * Path: Befund der Blutgasanalyse/Laborergebnis/Jedes
   * Ereignis/Sauerstoffsättigung/Ergebnis-Status Description: Status des Analyseergebnisses.
   */

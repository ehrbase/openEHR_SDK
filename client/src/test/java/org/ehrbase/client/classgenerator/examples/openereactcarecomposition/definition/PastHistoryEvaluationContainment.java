...
public class PastHistoryEvaluationContainment extends Containment {
  public SelectAqlField<PastHistoryEvaluation> PAST_HISTORY_EVALUATION = new AqlFieldImp<PastHistoryEvaluation>(PastHistoryEvaluation.class, "", "PastHistoryEvaluation", PastHistoryEvaluation.class, this);

  public SelectAqlField<String> SYNOPSIS_VALUE = new AqlFieldImp<String>(PastHistoryEvaluation.class, "/data[at0001]/items[at0002]/value|value", "synopsisValue", String.class, this);

  public ListSelectAqlField<Cluster> EXTENSION = new ListAqlFieldImp<Cluster>(PastHistoryEvaluation.class, "/protocol[at0003]/items[at0004]", "extension", Cluster.class, this);

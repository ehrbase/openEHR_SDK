...
public class StoryHistoryObservationContainment extends Containment {
  ...
  public ListSelectAqlField<StoryHistorySoftSignsElement> SOFT_SIGNS = new ListAqlFieldImp<StoryHistorySoftSignsElement>(StoryHistoryObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]", "softSigns", StoryHistorySoftSignsElement.class, this);

  public SelectAqlField<String> NOTES_VALUE = new AqlFieldImp<String>(StoryHistoryObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]/value|value", "notesValue", String.class, this);

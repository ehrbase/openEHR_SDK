...
public class ChestSymptomCluster implements LocatableEntity {
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Symptom/Sign name
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Structured body site
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Previous episodes
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Associated symptom/sign

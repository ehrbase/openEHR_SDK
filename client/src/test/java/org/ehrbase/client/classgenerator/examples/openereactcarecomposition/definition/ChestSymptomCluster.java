...
@Generated(
    ...
    date = "2020-12-10T13:06:11.474501500+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: null")
public class ChestSymptomCluster implements LocatableEntity {
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Symptom/Sign
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Structured body
   * site Description: Structured body site where the symptom or sign was reported. Comment: If the
   * anatomical location is included in the Symptom name via precoordinated codes, use of this SLOT
   * becomes redundant. If the anatomical location is recorded using the 'Body site' data element,
   * then use of CLUSTER archetypes in this SLOT is not allowed - record only the simple 'Body site'
   * OR 'Structured body site', but not both.
   */
  @Path("/items[at0147]")
  private List<Cluster> structuredBodySite;

  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Specific details
   * Description: Specific data elements that are additionally required to record as unique
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Previous
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Associated
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/Presence
  ...
  /** Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Chest symptom/feeder_audit */
  @Path("/feeder_audit")

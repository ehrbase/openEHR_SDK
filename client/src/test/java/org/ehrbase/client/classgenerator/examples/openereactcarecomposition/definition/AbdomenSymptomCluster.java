...
@Generated(
    ...
    date = "2021-02-16T12:59:53.674778800+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: null"
)
public class AbdomenSymptomCluster implements LocatableEntity {
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Abdomen symptom/Symptom/Sign name
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Abdomen symptom/Structured body site
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Abdomen symptom/Specific details
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Abdomen symptom/Previous episodes
  ...
  /**
   * Path: open_eREACT-Care/Assessment/Covid/Covid symptoms/Any event/Abdomen symptom/Associated symptom/sign

...
public class ErregertypisierungClusterContainment extends Containment {
  ...
  public ListSelectAqlField<ErregertypisierungArtDerTypisierungElement> ART_DER_TYPISIERUNG = new ListAqlFieldImp<ErregertypisierungArtDerTypisierungElement>(ErregertypisierungCluster.class, "/items[at0001]", "artDerTypisierung", ErregertypisierungArtDerTypisierungElement.class, this);

  public ListSelectAqlField<ErregertypisierungErgebnisElement> ERGEBNIS = new ListAqlFieldImp<ErregertypisierungErgebnisElement>(ErregertypisierungCluster.class, "/items[at0008]", "ergebnis", ErregertypisierungErgebnisElement.class, this);

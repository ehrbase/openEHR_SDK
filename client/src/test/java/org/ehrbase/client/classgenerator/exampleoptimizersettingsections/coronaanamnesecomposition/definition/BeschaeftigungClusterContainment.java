...
public class BeschaeftigungClusterContainment extends Containment {
  ...
  public SelectAqlField<String> BERUFSBEZEICHNUNG_ROLLE_VALUE = new AqlFieldImp<String>(BeschaeftigungCluster.class, "/items[at0005]/value|value", "berufsbezeichnungRolleValue", String.class, this);

  public ListSelectAqlField<OrganisationCluster> ORGANISATION = new ListAqlFieldImp<OrganisationCluster>(BeschaeftigungCluster.class, "/items[openEHR-EHR-CLUSTER.organisation_cc.v0]", "organisation", OrganisationCluster.class, this);

...
public class BefundObservationContainment extends Containment {
  ...
  public SelectAqlField<EmpfangerstandortCluster> EMPFANGERSTANDORT = new AqlFieldImp<EmpfangerstandortCluster>(BefundObservation.class, "/protocol[at0004]/items[openEHR-EHR-CLUSTER.location.v1]", "empfangerstandort", EmpfangerstandortCluster.class, this);
  ...
  public SelectAqlField<EinsenderstandortCluster> EINSENDERSTANDORT = new AqlFieldImp<EinsenderstandortCluster>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1]", "einsenderstandort", EinsenderstandortCluster.class, this);

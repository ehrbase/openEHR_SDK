...
public class BefundObservationContainment extends Containment {
  ...
  public SelectAqlField<EinsenderstandortCluster> EINSENDERSTANDORT = new AqlFieldImp<EinsenderstandortCluster>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1 and name/value='Einsenderstandort']", "einsenderstandort", EinsenderstandortCluster.class, this);

  public ListSelectAqlField<KulturCluster> KULTUR = new ListAqlFieldImp<KulturCluster>(BefundObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_panel.v0 and name/value='Kultur']", "kultur", KulturCluster.class, this);
  ...
  public SelectAqlField<DvIdentifier> AUFTRAGS_ID_DES_ANFORDERNDEN_EINSENDENDEN_SYSTEMS = new AqlFieldImp<DvIdentifier>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0062]/value", "auftragsIdDesAnforderndenEinsendendenSystems", DvIdentifier.class, this);

  public SelectAqlField<DvIdentifier> AUFTRAGS_ID_EMPFANGER = new AqlFieldImp<DvIdentifier>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0063]/value", "auftragsIdEmpfanger", DvIdentifier.class, this);

  public SelectAqlField<String> LABORTEST_BEZEICHNUNG_VALUE = new AqlFieldImp<String>(BefundObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0005]/value|value", "labortestBezeichnungValue", String.class, this);

  public ListSelectAqlField<Cluster> STRUKTURIERTE_ERFASSUNG_DER_STORFAKTOREN = new ListAqlFieldImp<Cluster>(BefundObservation.class, "/data[at0001]/events[at0002]/state[at0112]/items[at0114]", "strukturierteErfassungDerStorfaktoren", Cluster.class, this);
  ...
  public SelectAqlField<EmpfangerstandortCluster> EMPFANGERSTANDORT = new AqlFieldImp<EmpfangerstandortCluster>(BefundObservation.class, "/protocol[at0004]/items[openEHR-EHR-CLUSTER.location.v1 and name/value='Empfängerstandort']", "empfangerstandort", EmpfangerstandortCluster.class, this);
  ...
  public ListSelectAqlField<EmpfangerstandortAnforderungElement> ANFORDERUNG = new ListAqlFieldImp<EmpfangerstandortAnforderungElement>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0106]", "anforderung", EmpfangerstandortAnforderungElement.class, this);

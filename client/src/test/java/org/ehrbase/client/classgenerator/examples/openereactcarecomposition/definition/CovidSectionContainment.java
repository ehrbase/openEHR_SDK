...
public class CovidSectionContainment extends Containment {
  ...
  public SelectAqlField<CovidSymptomsObservation> COVID_SYMPTOMS = new AqlFieldImp<CovidSymptomsObservation>(CovidSection.class, "/items[openEHR-EHR-OBSERVATION.story.v1]", "covidSymptoms", CovidSymptomsObservation.class, this);

  public SelectAqlField<Covid19ExposureEvaluation> COVID19_EXPOSURE = new AqlFieldImp<Covid19ExposureEvaluation>(CovidSection.class, "/items[openEHR-EHR-EVALUATION.health_risk-covid.v0]", "covid19Exposure", Covid19ExposureEvaluation.class, this);

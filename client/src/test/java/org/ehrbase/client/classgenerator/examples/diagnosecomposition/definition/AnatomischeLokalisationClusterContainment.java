...
public class AnatomischeLokalisationClusterContainment extends Containment {
  ...
  public SelectAqlField<LateralitatDefiningCode> LATERALITAT_DEFINING_CODE = new AqlFieldImp<LateralitatDefiningCode>(AnatomischeLokalisationCluster.class, "/items[at0002]/value|defining_code", "lateralitatDefiningCode", LateralitatDefiningCode.class, this);

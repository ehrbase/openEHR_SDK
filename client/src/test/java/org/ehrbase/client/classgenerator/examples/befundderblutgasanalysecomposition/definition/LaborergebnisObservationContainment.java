...
public class LaborergebnisObservationContainment extends Containment {
  ...
  public SelectAqlField<KohlendioxidpartialdruckCluster> KOHLENDIOXIDPARTIALDRUCK = new AqlFieldImp<KohlendioxidpartialdruckCluster>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "kohlendioxidpartialdruck", KohlendioxidpartialdruckCluster.class, this);

  public SelectAqlField<SauerstoffpartialdruckCluster> SAUERSTOFFPARTIALDRUCK = new AqlFieldImp<SauerstoffpartialdruckCluster>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "sauerstoffpartialdruck", SauerstoffpartialdruckCluster.class, this);

  public SelectAqlField<PhWertCluster> PH_WERT = new AqlFieldImp<PhWertCluster>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "phWert", PhWertCluster.class, this);

  public SelectAqlField<SauerstoffsattigungCluster> SAUERSTOFFSATTIGUNG = new AqlFieldImp<SauerstoffsattigungCluster>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "sauerstoffsattigung", SauerstoffsattigungCluster.class, this);

...
public class SchwangerschaftsstatusObservationContainment extends Containment {
  ...
  public SelectAqlField<StatusDefiningcode2> STATUS_DEFININGCODE = new AqlFieldImp<StatusDefiningcode2>(SchwangerschaftsstatusObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0011]/value|defining_code", "statusDefiningcode", StatusDefiningcode2.class, this);

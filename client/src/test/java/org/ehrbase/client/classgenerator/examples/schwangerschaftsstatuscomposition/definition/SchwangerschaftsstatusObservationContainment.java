...
public class SchwangerschaftsstatusObservationContainment extends Containment {
  ...
  public SelectAqlField<StatusDefiningCode2> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode2>(SchwangerschaftsstatusObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0011]/value|defining_code", "statusDefiningCode", StatusDefiningCode2.class, this);

...
public class PatientenaufenthaltCompositionContainment extends Containment {
  ...
  public SelectAqlField<VersorgungsfallCluster> VERSORGUNGSFALL = new AqlFieldImp<VersorgungsfallCluster>(PatientenaufenthaltComposition.class, "/context/other_context[at0001]/items[openEHR-EHR-CLUSTER.case_identification.v0]", "versorgungsfall", VersorgungsfallCluster.class, this);

  public SelectAqlField<AbteilungsfallCluster> ABTEILUNGSFALL = new AqlFieldImp<AbteilungsfallCluster>(PatientenaufenthaltComposition.class, "/context/other_context[at0001]/items[openEHR-EHR-CLUSTER.case_identification.v0]", "abteilungsfall", AbteilungsfallCluster.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(PatientenaufenthaltComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

  public SelectAqlField<VersorgungsortAdminEntry> VERSORGUNGSORT = new AqlFieldImp<VersorgungsortAdminEntry>(PatientenaufenthaltComposition.class, "/content[openEHR-EHR-ADMIN_ENTRY.hospitalization.v0]", "versorgungsort", VersorgungsortAdminEntry.class, this);
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(PatientenaufenthaltComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);

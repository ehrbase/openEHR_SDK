...
public class FieberOderErhohteKorpertemperaturObservationContainment extends Containment {
    ...
    public SelectAqlField<PartyProxy> SUBJECT = new AqlFieldImp<PartyProxy>(
            FieberOderErhohteKorpertemperaturObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE = new AqlFieldImp<Language>(
            FieberOderErhohteKorpertemperaturObservation.class, "/language", "language", Language.class, this);

...
public class ItemStructureVisitorTest {
  ...
  public void elementVisitorTest2() throws Throwable {
    ...
    assertEquals(
        61,
        itemStructureVisitor
            .getElementOccurrences()); // 4 elements are in the context/other_context structure
  ...
  public void elementVisitorTest3() throws Throwable {
    ...
    Composition composition =
        (Composition)
            unmarshaller.unmarshal(
                new FileInputStream(
                    new File(
                        "./src/test/resources/composition/RIPPLE-ConformanceTest_invalid_other_context_mm_type.xml")));
    ...
    try {
      ...
      assertTrue(
          e.getMessage()
              .contains("supplied code string [video/mp4] is not found in codeset:media types"));
    }
  }
  ...
  public void ehrVisitorTest() throws Throwable {
    ...
    EhrStatus ehrStatus =
        new EhrStatus(
            "ehr_status",
            new DvText("ehr_status"),
            new PartySelf(new PartyRef()),
            true,
            true,
            otherDetails);
  ...
  @Test
  public void testValidateTestAllTypesWithInvalidParticipations()
      throws IOException, JAXBException {
    Unmarshaller unmarshaller = JAXBUtil.getArchieJAXBContext().createUnmarshaller();
    Composition composition =
        (Composition)
            unmarshaller.unmarshal(
                CompositionTestDataCanonicalXML.ALL_TYPES_INVALID_PARTICIPATIONS.getStream());

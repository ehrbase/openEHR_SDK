...
public class TerminologyCheckTest {
    ...
    public void testSimpleValidation() {
        ...
        DvCodedTextCheck.validate("category", category, "en");
    }

    @Test
    public void testSimpleValidationWrongCode() {
    ...
    @Test
    public void testSimpleValidationWrongValue() {
    ...
    @Test
    public void testSimpleValidationLanguageWrong() {
        CodePhrase codePhrase = new CodePhrase(new TerminologyId("ISO_3166-1"), "ZZ");
        try {
            CodePhraseCheck.validate("territory", codePhrase, "en");
            fail("should have detected a wrong value");
        } catch (Exception e) {
        }
    }
    ...
    public void testSimpleValidationSymbol() {
        ...
        DvCodedTextCheck.validate("symbol", symbol, "en");
    }
}

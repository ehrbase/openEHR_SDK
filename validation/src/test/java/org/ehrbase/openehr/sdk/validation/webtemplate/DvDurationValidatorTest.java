...
class DvDurationValidatorTest extends AbstractRMObjectValidatorTest {
    ...
    void testValidate_Duration() throws Exception {
        ...
        assertThat(result)
                .extracting(ConstraintViolation::getAqlPath, ConstraintViolation::getMessage)
                .containsExactlyInAnyOrder(
                        new Tuple("/test/dv_duration_duration", "The value PT20H45M45S must be <= PT12H30M15S"));
    ...
    void testValidate_Period() throws Exception {
        ...
        assertThat(result)
                .extracting(ConstraintViolation::getAqlPath, ConstraintViolation::getMessage)
                .containsExactlyInAnyOrder(new Tuple("/test/dv_duration_period", "The value PT2H must be > P1M"));
    }
    ...
    void testValidate_PeriodDuration() throws Exception {
        ...
        assertThat(result)
                ...
                .containsExactlyInAnyOrder(new Tuple(
                        "/test/dv_duration_duration", "The value P33Y5M17DT5H30M5S must be < P20YT10H30M15S"));
        // less than Validation Range
        result = validator.validate(new DvDuration("PT10H30M15S"), node);
        assertThat(result)
                .extracting(ConstraintViolation::getAqlPath, ConstraintViolation::getMessage)
                .containsExactlyInAnyOrder(
                        new Tuple("/test/dv_duration_duration", "The value PT10H30M15S must be >= P5Y4M15D"));
    }
}

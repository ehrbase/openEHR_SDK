 ...
 *
 * @link
 *     https://specifications.openehr.org/releases/AM/latest/AOM1.4.html#_c_multiple_attribute_class
...
public class CMultipleAttribute extends CConstraint implements I_CArchetypeConstraintValidate {
  ...
  public void validate(String path, Object aValue, ARCHETYPECONSTRAINT archetypeconstraint)
    ...
    IntervalComparator.isWithinBoundaries(
        cmultipleattribute.sizeOfChildrenArray(), intervalOfInteger);

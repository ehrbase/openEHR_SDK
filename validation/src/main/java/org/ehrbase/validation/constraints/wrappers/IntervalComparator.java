...
public class IntervalComparator {
  ...
  private static void isWithinLxUx(Comparable value, Comparable lower, Comparable upper)
    ...
    throw new IllegalArgumentException(
        "value is not within interval, expected:" + lower + " < " + value + " < " + upper);
  }

  // lower inclusive, upper exclusive
  private static void isWithinLiUx(Comparable value, Comparable lower, Comparable upper)
      throws IllegalArgumentException {
    if (value.compareTo(lower) >= 0 && value.compareTo(upper) < 0) return;
    throw new IllegalArgumentException(
        "value is not within interval, expected:" + lower + " <= " + value + " < " + upper);
  ...
  private static void isWithinLxUi(Comparable value, Comparable lower, Comparable upper)
      throws IllegalArgumentException {
    if (value.compareTo(lower) > 0 && value.compareTo(upper) <= 0) return;
    throw new IllegalArgumentException(
        "value is not within interval, expected:" + lower + " < " + value + " <= " + upper);
  ...
  private static void isWithinLiUi(Comparable value, Comparable lower, Comparable upper)
      throws IllegalArgumentException {
    if (value.compareTo(lower) >= 0 && value.compareTo(upper) <= 0) return;
    throw new IllegalArgumentException(
        "value is not within interval, expected:" + lower + " <= " + value + " <= " + upper);
  ...
  private static void compareWithinInterval(
      Comparable value, Interval interval, Comparable lower, Comparable upper)
      throws IllegalArgumentException {
    ...
    if (isLowerIncluded && isUpperIncluded) isWithinLiUi(value, lower, upper);
    else if (isLowerIncluded && !isUpperIncluded) isWithinLiUx(value, lower, upper);
    else if (!isLowerIncluded && isUpperIncluded) isWithinLxUi(value, lower, upper);
    else if (!isLowerIncluded && !isUpperIncluded) isWithinLxUx(value, lower, upper);
  }

  //    private static void compareWithinInterval(Comparable value, ConstraintOccurrences
  // occurrences, Comparable lower, Comparable upper) throws IllegalArgumentException {
  //        boolean isLowerIncluded = (occurrences.getLowerIncluded() ?
  // occurrences.getLowerIncluded() : false);
  //        boolean isUpperIncluded = (occurrences.getLowerIncluded() ?
  // occurrences.getUpperIncluded() : false);
  //
  ...
  public static void isWithinBoundaries(Float real, IntervalOfReal intervalOfReal)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(Integer integer, IntervalOfInteger intervalOfInteger)
      throws IllegalArgumentException {
    Integer lower =
        (intervalOfInteger.isSetLower() ? intervalOfInteger.getLower() : Integer.MIN_VALUE);
    Integer upper =
        (intervalOfInteger.isSetUpper() ? intervalOfInteger.getUpper() : Integer.MAX_VALUE);

    compareWithinInterval(integer, intervalOfInteger, lower, upper);
  }

  public static void isWithinBoundaries(Integer integer, ConstraintOccurrences occurrences)
      throws IllegalArgumentException {
  ...
  static void isWithinPrecision(Integer integer, IntervalOfInteger intervalOfInteger)
      throws IllegalArgumentException {
    if (intervalOfInteger == null) return;
    Integer lower =
        (intervalOfInteger.isSetLower() ? intervalOfInteger.getLower() : Integer.MIN_VALUE);
    Integer upper =
        (intervalOfInteger.isSetUpper() ? intervalOfInteger.getUpper() : Integer.MAX_VALUE);
  ...
  public static void isWithinBoundaries(String rawDate, IntervalOfDate intervalOfDate)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(DvDate date, IntervalOfDate intervalOfDate)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(DvDateTime dateTime, IntervalOfDateTime intervalOfDateTime)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(DvTime dateTime, IntervalOfTime intervalOfTime)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(ZonedDateTime valueDate, IntervalOfDate intervalOfDate)
      throws IllegalArgumentException {
    ...
    // Date massage...
    if (lower != null) lowerDate = ZonedDateTime.parse(lower);
    else lowerDate = new ZonedDateTimeUtil().min();

    if (upper != null) upperDate = ZonedDateTime.parse(upper);
    else upperDate = new ZonedDateTimeUtil().max();

    compareWithinInterval(valueDate, intervalOfDate, lowerDate, upperDate);
  }

  public static void isWithinBoundaries(String rawDateTime, IntervalOfDateTime intervalOfDateTime)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(
      ZonedDateTime valueDateTime, IntervalOfDateTime intervalOfDateTime)
      throws IllegalArgumentException {
    ...
    // Date massage...
    if (lower != null) lowerDateTime = ZonedDateTime.parse(lower);
    else lowerDateTime = new ZonedDateTimeUtil().min();

    if (upper != null) upperDateTime = ZonedDateTime.parse(upper);
    else upperDateTime = new ZonedDateTimeUtil().max();

    compareWithinInterval(valueDateTime, intervalOfDateTime, lowerDateTime, upperDateTime);
  }

  public static void isWithinBoundaries(String rawTime, IntervalOfTime intervalOfTime)
      throws IllegalArgumentException {
    ZonedDateTime valueTime = ZonedDateTime.parse(rawTime);
    isWithinBoundaries(valueTime, intervalOfTime);
  }

  public static void isWithinBoundaries(ZonedDateTime valueTime, IntervalOfTime intervalOfTime)
      throws IllegalArgumentException {
    ...
    // Date massage...
    if (lower != null) lowerTime = ZonedDateTime.parse(lower);
    else lowerTime = new ZonedDateTimeUtil().min();

    if (upper != null) upperTime = ZonedDateTime.parse(upper);
    else upperTime = new ZonedDateTimeUtil().min();

    compareWithinInterval(valueTime, intervalOfTime, lowerTime, upperTime);
  }

  public static void isWithinBoundaries(String rawDuration, IntervalOfDuration intervalOfDuration)
      throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(
      Duration valueDuration, IntervalOfDuration intervalOfDuration)
      throws IllegalArgumentException {
    ...
    // Date massage...
    if (lower != null) lowerDuration = Duration.parse(lower);
    else lowerDuration = Duration.ZERO;

    if (upper != null) upperDuration = Duration.parse(upper);
    else upperDuration = Duration.of(Long.MAX_VALUE, ChronoUnit.FOREVER);
  ...
  public static boolean isOptional(IntervalOfInteger intervalOfInteger) {
    if (intervalOfInteger.isSetLower()
        && intervalOfInteger.getLower() == 1
        && intervalOfInteger.isSetUpper()
        && intervalOfInteger.getUpper() == 1) return false;
   ...
   * @return
   */
  private static IntervalOfInteger makeOptInterval(
      com.nedap.archie.base.Interval<Integer> integerInterval) {
  ...
  public static String toString(IntervalOfInteger intervalOfInteger) {
    ...
    stringBuffer.append("[");
    if (intervalOfInteger.isSetLower()) stringBuffer.append(intervalOfInteger.getLower());
    else stringBuffer.append("*");
    stringBuffer.append("..");
    if (intervalOfInteger.isSetUpper()) stringBuffer.append(intervalOfInteger.getUpper());
    else stringBuffer.append("*");
    stringBuffer.append("]");

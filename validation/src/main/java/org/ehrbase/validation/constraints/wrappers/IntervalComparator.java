...
//    }
  ...
  public static void isWithinBoundaries(Integer integer, IntervalOfInteger intervalOfInteger)
      throws IllegalArgumentException {
    Integer lower = (intervalOfInteger.isSetLower() ? intervalOfInteger.getLower()
        : Integer.MIN_VALUE);
    Integer upper = (intervalOfInteger.isSetUpper() ? intervalOfInteger.getUpper()
        : Integer.MAX_VALUE);
  ...
  public static void isWithinBoundaries(ZonedDateTime valueDateTime,
      IntervalOfDateTime intervalOfDateTime) throws IllegalArgumentException {
  ...
  public static void isWithinBoundaries(DvDuration valueDuration,
    ...
    try {
      DvDuration lowerDuration;
      if (lower == null || lower.equals(Period.ZERO.toString())) {
        lowerDuration = new DvDuration(Duration.ZERO);
      } else {
        lowerDuration = new DvDuration(lower);
      }

      DvDuration upperDuration;
      if (upper == null) {
        upperDuration = new DvDuration(ChronoUnit.FOREVER.getDuration());
  ...
  public static boolean isOptional(IntervalOfInteger intervalOfInteger) {
    if (intervalOfInteger.isSetLower() && intervalOfInteger.getLower() == 1
        && intervalOfInteger.isSetUpper() && intervalOfInteger.getUpper() == 1) {
      return false;
    }
  ...
  public static String toString(com.nedap.archie.base.Interval<Integer> intervalOfInteger) {
    ...
    stringBuffer.append("[");
    if (intervalOfInteger.getLower() != null
        && intervalOfInteger.getLower() != Integer.MIN_VALUE) {
      stringBuffer.append(intervalOfInteger.getLower());
    } else {
      stringBuffer.append("*");
    }
    stringBuffer.append("..");
    if (intervalOfInteger.getUpper() != null
        && intervalOfInteger.getUpper() != Integer.MAX_VALUE) {
      stringBuffer.append(intervalOfInteger.getUpper());
    } else {
      stringBuffer.append("*");
    }

...
public interface I_CArchetypeConstraintValidate {
  ...
  static String getXmlType(ARCHETYPECONSTRAINT archetypeconstraint) {
    ...
    if (attributeValue.contains(":")) return attributeValue.split(":")[1];
    else return attribute.getStringValue();
  }
  ...
  void validate(String path, Object aValue, ARCHETYPECONSTRAINT archetypeconstraint)

...
## [unreleased]
 ### Added 
   ...
   - Added stored query text plain request support ([#1021](https://github.com/ehrbase/ehrbase/pull/1021))
...
[unreleased]: https://github.com/ehrbase/openEHR_SDK/compare/v1.23.0...HEAD

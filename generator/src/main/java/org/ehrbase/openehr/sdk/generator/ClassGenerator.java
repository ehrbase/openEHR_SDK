...
import org.ehrbase.openehr.sdk.webtemplate.filter.WebTemplateFilter;
...
public class ClassGenerator {
    ...
    public ClassGenerator(ClassGeneratorConfig config) {
        ...
        this(new ClassGeneratorFilter(config), new DefaultNamingStrategy(config));
    }
    ...
    private void addVersionUid(TypeSpec.Builder classBuilder) {
        FieldSpec versionUid = FieldSpec.builder(ObjectVersionId.class, "versionUid", Modifier.PRIVATE)

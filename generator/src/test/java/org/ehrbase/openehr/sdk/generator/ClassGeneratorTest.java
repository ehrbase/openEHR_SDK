    ...
    public void testGenerate() throws IOException, XmlException {
        ...
        assertThat(fieldSpecs)
                ...
                .containsExactlyInAnyOrder(
                        new Tuple("versionUid", "com.nedap.archie.rm.support.identification.ObjectVersionId"),
                        new Tuple("device", "java.util.List<com.nedap.archie.rm.datastructures.Cluster>"),
                        new Tuple("language", "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.Language"),
                        ...
                        new Tuple(
                                "settingDefiningCode",
                                "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.Setting"),
                        new Tuple("territory", "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.Territory"),
                        new Tuple(
                        ...
                        new Tuple(
                                ...
                                "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.Category"),
                        ...
                        new Tuple(
                                ...
                                "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.NullFlavour"),
                        new Tuple(
    ...
    private void writeFiles(ClassGeneratorResult generate) throws IOException {
        if (WRITE_FILES) {
            ...
            generate.getClasses().keySet().stream()
                    ...
                    .ifPresent(s -> {
                        try {
                            FileUtils.cleanDirectory(Paths.get(String.valueOf(path), s.replace(".", "/"))
                                    .toFile());
                        } catch (Exception e) {
                            // NOP
                        }
        ...
        assertThat(fieldSpecs)
                ...
                .containsExactlyInAnyOrder(
                        ...
                        new Tuple(
                                ...
                                "org.ehrbase.openehr.sdk.generator.commons.shareddefinition.MathFunction"),
                        new Tuple(
                                "birthEn",

...
public final class AqlPath implements Serializable {
  ...
  public AqlPath addEnd(String ... pathExp) {
    ...
    AqlPath[] paths = Arrays.stream(pathExp)
            .map(AqlPath::parse)
            .toArray(AqlPath[]::new);
  ...
  public static AqlPath parse(String pathExp, String nameValue) {
    ...
    for (int i = 0; i < nodeStrings.length; i++) {
      ...
      parseNode(currentNode, isLastNode, nameValue)
        .ifPresent(nodes::add);
    }
  ...
  public static final class AqlNode implements Serializable {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(name, aqlNode.name) && Objects.equals(atCode, aqlNode.atCode) && Objects.equals(otherPredicates, aqlNode.otherPredicates);
    }
    ...
    public void appendFormat(StringBuilder sb, OtherPredicatesFormat otherPredicatesFormat) {
      ...
      if (this.atCode != null) {
        ...
        if (otherPredicatesFormat != OtherPredicatesFormat.NONE) {
          this.otherPredicates.forEach(
                  (key, value) -> {
                    //XXX escape value?? ('\)
                    if (otherPredicatesFormat == OtherPredicatesFormat.SHORTED
                            && key.equals(NAME_VALUE_KEY)) {

...
public class AqlPathTest {
  ...
  public void testParseWithAndInName() {
    ...
    assertThat(path2).hasToString("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1 and name/value='foo']");
  }
  ...
  public void testParseWithPredicateInShortForm() {
    ...
    assertThat(cut)
            .hasToString("/content[openEHR-EHR-SECTION.adhoc.v1 and name/value='Symptome']");
    assertThat(cut.format(false)).isEqualTo("/content[openEHR-EHR-SECTION.adhoc.v1]");
  }
  ...
  public void testRemoveStartAqlPath() {
    AqlPath path1 =
            AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]|magnitude");
  ...
  public void testFormatRemoveStartNodes() {
    ...
    assertThat(path.removeStart(1)).isEqualTo(AqlPath.parse("/events[at0002]/data[at0003]/items[at0004]|magnitude"));
  ...
  public void testAddEndStrings() {
    ...
    assertThat(path.addEnd("events[at0002]", "", "/", "/data[at0003]/items[at0004]|magnitude")).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]|magnitude"));
  ...
  public void testAddEndNodes() {
    ...
    assertThat(path.addEnd(n1, n2, n3)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]"));
  }
  ...
  public void testReplaceNodeAtPos() {
    ...
    assertThat(path.replaceNode(2, node)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/foo[at0666]/items[at0004]|magnitude"));
    assertThat(path.replaceNode(3, node)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/foo[at0666]|magnitude"));
  }
  ...
  public void testReplaceLastNode() {
    ...
    assertThat(path.replaceLastNode(n -> node)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/foo[at0666]|magnitude"));
    assertThat(path.replaceLastNode(n -> n)).isSameAs(path);
    assertThat(path.replaceLastNode(n -> null)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]"));
  ...
  public void testWithAttributeName() {
    AqlPath path = AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]|magnitude");
    assertThat(path.withAttributeName("foo")).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]|foo"));
    assertThat(path.withAttributeName(null)).isEqualTo(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]"));
  }
  ...
  public void testIsEmpty() {
    ...
    assertThat(AqlPath.parse("/data[at0001]/events[at0002]/data[at0003]/items[at0004]|magnitude").isEmpty()).isFalse();
  }
  ...
  public void testFormatBoolean() {
    AqlPath path = AqlPath.parse("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(false)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1]/protocol[at0004]/items[at0094]|foo");
  }

  @Test
  public void testFormatEnum() {
    AqlPath path = AqlPath.parse("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.FULL, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.FULL, false)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.SHORTED, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1,'Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.SHORTED, false)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1,'Einsenderstandort']/protocol[at0004]/items[at0094]");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.NONE, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1]/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.NONE, false)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1]/protocol[at0004]/items[at0094]");
  }
  ...
  public void testParseSpace() {
    ...
    path = AqlPath.parse("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1, 'Einsenderstandort']/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1]");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.FULL, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1]");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.SHORTED, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1,'Einsenderstandort']/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1]");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.NONE, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1]/protocol[at0004]/items[at0094]/items[openEHR-EHR-CLUSTER.location.v1]");

    path = AqlPath.parse("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value = 'Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.FULL, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1 and name/value='Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
    assertThat(path.format(AqlPath.OtherPredicatesFormat.SHORTED, true)).isEqualTo("/content[openEHR-EHR-OBSERVATION.laboratory_test_result.v1,'Einsenderstandort']/protocol[at0004]/items[at0094]|foo");
  }
}

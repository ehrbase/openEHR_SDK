...
public enum CompositionTestDataConformanceSDTJson implements CompositionTestDataSimSDTJsonInterface {
    ...
    EHRBASE_CONFORMANCE_CLUSTER(
            "ehrbase_conformance_cluster", "ehrbase_conformance_cluster.json", OperationalTemplateTestData.CONFORMANCE),
    ...
    EHRBASE_CONFORMANCE_ACTION(
            "ehrbase_conformance_action", "ehrbase_conformance_action.json", OperationalTemplateTestData.CONFORMANCE),
    ...
    EHRBASE_CONFORMANCE_SECTION(
            "ehrbase_conformance_section", "ehrbase_conformance_section.json", OperationalTemplateTestData.CONFORMANCE),
    EHRBASE_CONFORMANCE_PARTY_IDENTIFIED(
            "ehrbase_conformance_party_identified",
            "ehrbase_conformance_party_identified.json",
            OperationalTemplateTestData.CONFORMANCE),
    EHRBASE_CONFORMANCE_PARTY_RELATED(
            "ehrbase_conformance_party_related",
            "ehrbase_conformance_party_related.json",
            OperationalTemplateTestData.CONFORMANCE),
    EHRBASE_CONFORMANCE_PARTY_SELF(
            "ehrbase_conformance_party_self",
            "ehrbase_conformance_party_self.json",
            OperationalTemplateTestData.CONFORMANCE),
    ...
    CompositionTestDataConformanceSDTJson(String description, String filename, OperationalTemplateTestData template) {

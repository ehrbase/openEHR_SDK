...
public enum OperationalTemplateTestData {
    IDCR_IMMUNISATION_SUMMARY(
            "IDCR Immunisation summary", "IDCR - Immunisation summary.v0.opt", "IDCR - Immunisation summary.v0"),
    RIPPLE_CONFORMANCE_TEST(
            "RIPPLE Conformance Test", "RIPPLE-Conformance Test.opt", "RIPPLE - Conformance Test template"),
    IDCR_LABORATORY_TEST(
            "IDCR  Laboratory Test Report", "IDCR - Laboratory Test Report.v0.opt", "IDCR - Laboratory Test Report.v0"),
    ...
    MULTI_OCCURRENCE(
            "Template with multiple occurrence", "ehrbase_multi_occurrence.de.opt", "ehrbase_multi_occurrence.de.v1"),
    EREACT_COVID_MANAGEMENT("Template with action", "EREACT - COVID management.v0.opt", "EREACT - COVID management.v0"),
    ...
    WORD_WITH_AND("Template with archetype with and in name ", "wordwithandin_test.v0.opt", "wordwithandin_test.v0"),
    ...
    NCD("ncd", "NCD.opt", "NCD"),
    CONFORMANCE("ehrbase conformance test template", "conformance_ehrbase.de.v0.opt", "conformance-ehrbase.de.v0"),
    ...
    REPEATING_ARCHETYPES("template with repeating archetypes", "aql_demo.hip.de.v0.opt", "aql_demo.hip.de.v0"),
    ...
    INTERVAL_PARTIAL_DATE(
            "Interval with partial date time constraint",
            "Test_quantity_dv_interval_dv_date_time_open_constraint.v0.opt",
            "Test_quantity_dv_interval_dv_date_time_open_constraint.v0");

...
public enum CompositionTestDataCanonicalXML {
    ...
    RIPPLE_COMFORMANCE_ACTION(
            "Action section from Ripple comformance", "RIPPLE_conformanceTesting_ACTION.procedure.v1.xml"),
    ...
    RIPPLE_COMFORMANCE_EVALUATION(
            "Evaluation section from Ripple comformance", "RIPPLE_conformanceTesting_EVALUATION.cpr_decision_uk.xml"),
    RIPPLE_COMFORMANCE_OBSERVATION_DEMO(
            "Observation demo section from Ripple comformance", "RIPPLE_conformanceTesting_OBSERVATION.demo.v1.xml"),
    RIPPLE_COMFORMANCE_OBSERVATION_PULSE(
            "Observation UI demo from Ripple comformance", "RIPPLE_conformanceTesting_OBSERVATION.pulse.v1.xml"),
    ...
    ALL_TYPES_INVALID_PARTICIPATIONS(
            "simple test with participations holding a wrong value", "test_all_types_participations_invalid.xml"),

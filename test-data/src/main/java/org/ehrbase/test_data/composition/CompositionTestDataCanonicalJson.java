...
public enum CompositionTestDataCanonicalJson {
  ...
  MINIMAL_EVAL_NAMED_ITEM_TREE(
      "Minimal Evaluation modified", "minimal_evaluation_item_tree_name.json"),
  ...
  SUBJECT_PARTY_IDENTIFIED(
      "Nested subject PARTY_IDENTIFIED", "compo_with_nested_party_identified.json"),
  ...
  VIROLOGY_FINDING_WITH_SPECIMEN(
      "virology finding with specimen", "virology_finding_with_specimen.json"),
  ...
  CHOICE_ELEMENT(
      "element containing multiple choice to test validation", "choice_validation_test.json"),

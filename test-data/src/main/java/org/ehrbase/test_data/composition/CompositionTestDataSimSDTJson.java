...
public enum CompositionTestDataSimSDTJson implements CompositionTestDataSimSDTJsonInterface {
    ALTERNATIVE_EVENTS("AlternativeEvents", "AlternativeEvents.json", OperationalTemplateTestData.ALT_EVENTS),
    ALTERNATIVE_EVENTS_2("AlternativeEvents", "AlternativeEvents2.json", OperationalTemplateTestData.ALT_EVENTS),
    ...
    CORONA_WITH_CONTEXT("Corona", "corona_with_context.json", OperationalTemplateTestData.CORONA_ANAMNESE),
    CORONA_WITH_FEEDER_AUDIT(
            "Corona with feeder audit", "corona_with_feeder_audit.json", OperationalTemplateTestData.CORONA_ANAMNESE),
    ...
    CORONA_WITH_RAW("Corona with raw field", "corona_with_raw.json", OperationalTemplateTestData.CORONA_ANAMNESE),
    MULTI_OCCURRENCE("multi_occurrence", "multi_occurrence.json", OperationalTemplateTestData.MULTI_OCCURRENCE),
    MISSING_COUNT(
    ...
    DURATION_VALIDATION(
            "duration_validation", "duration_validation.json", OperationalTemplateTestData.DURATION_VALIDATION),
    ...
    ISM_WRONG(
            "ISM transition with wrong current state",
            "ism_wrong_current_state.json",
            OperationalTemplateTestData.ISM_WRONG),
    ...
    CompositionTestDataSimSDTJson(String description, String filename, OperationalTemplateTestData template) {

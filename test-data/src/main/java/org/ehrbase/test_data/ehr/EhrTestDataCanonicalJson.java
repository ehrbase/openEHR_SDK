...
package org.ehrbase.test_data.ehr;
...
public enum EhrTestDataCanonicalJson {
    ...
    EHR_STATUS_SUBJECT_EXTERNAL_REF_OTHER_DETAILS("EhrStatus with subject as ExternalRef and other_details", "ehr_status_other_details_simple.json");

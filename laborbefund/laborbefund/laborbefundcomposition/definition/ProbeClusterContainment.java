...
public class ProbeClusterContainment extends Containment {
  ...
  public SelectAqlField<String> ZEITPUNKT_DES_PROBENEINGANGS_VALUE_NAME = new AqlFieldImp<String>(ProbeCluster.class, "/items[at0034]/name|value", "zeitpunktDesProbeneingangsValueName", String.class, this);

  public SelectAqlField<String> ZEITPUNKT_DER_PROBENENTNAHME_VALUE = new AqlFieldImp<String>(ProbeCluster.class, "/items[at0015]/name|value", "zeitpunktDerProbenentnahmeValue", String.class, this);
  ...
  public SelectAqlField<TemporalAccessor> ZEITPUNKT_DER_PROBENENTNAHME_VALUE_VALUE = new AqlFieldImp<TemporalAccessor>(ProbeCluster.class, "/items[at0015]/value|value", "zeitpunktDerProbenentnahmeValueValue", TemporalAccessor.class, this);

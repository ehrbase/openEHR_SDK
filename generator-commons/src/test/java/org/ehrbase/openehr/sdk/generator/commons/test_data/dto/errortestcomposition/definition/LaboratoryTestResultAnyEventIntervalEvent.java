...
@Generated(
        ...
        date = "2022-03-02T14:11:00.833600600+01:00",
        comments = "https://github.com/ehrbase/openEHR_SDK Version: null")
@OptionFor("INTERVAL_EVENT")
public class LaboratoryTestResultAnyEventIntervalEvent
        implements IntervalEventEntity, LaboratoryTestResultAnyEventChoice {
    /**
    ...
    /** Path: ErrorTest/Laboratory test result/Any event/width */
    @Path("/width|value")
    private TemporalAmount widthValue;

    /** Path: ErrorTest/Laboratory test result/Any event/math_function */
    @Path("/math_function|defining_code")
    private MathFunction mathFunctionDefiningCode;

    /** Path: ErrorTest/Laboratory test result/Any event/sample_count */
    @Path("/sample_count")

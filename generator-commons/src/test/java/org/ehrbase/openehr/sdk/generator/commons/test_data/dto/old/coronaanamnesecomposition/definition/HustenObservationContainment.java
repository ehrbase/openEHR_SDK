...
public class HustenObservationContainment extends Containment {
    public SelectAqlField<HustenObservation> HUSTEN_OBSERVATION = new AqlFieldImp<HustenObservation>(
            HustenObservation.class, "", "HustenObservation", HustenObservation.class, this);

    public SelectAqlField<Language> LANGUAGE =
            new AqlFieldImp<Language>(HustenObservation.class, "/language", "language", Language.class, this);

    public ListSelectAqlField<Cluster> ERWEITERUNG = new ListAqlFieldImp<Cluster>(
            HustenObservation.class, "/protocol[at0007]/items[at0021]", "erweiterung", Cluster.class, this);
    ...
    public SelectAqlField<PartyProxy> SUBJECT =
            new AqlFieldImp<PartyProxy>(HustenObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<TemporalAccessor> ORIGIN_VALUE = new AqlFieldImp<TemporalAccessor>(
            HustenObservation.class, "/data[at0001]/origin|value", "originValue", TemporalAccessor.class, this);

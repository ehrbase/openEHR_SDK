...
public class LatestCovid19TestObservationContainment extends Containment {
    ...
    public SelectAqlField<String> TEST_NAME_VALUE = new AqlFieldImp<String>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> SPECIMEN_DETAIL = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> TEST_RESULT = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class,
    ...
    public SelectAqlField<String> TEST_DIAGNOSIS_VALUE = new AqlFieldImp<String>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> STRUCTURED_TEST_DIAGNOSIS = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> MULTIMEDIA_REPRESENTATION = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> STRUCTURED_CONFOUNDING_FACTORS = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class,
    ...
    public ListSelectAqlField<Cluster> EXTENSION = new ListAqlFieldImp<Cluster>(
            LatestCovid19TestObservation.class, "/protocol[at0004]/items[at0117]", "extension", Cluster.class, this);
    ...
    public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(
            LatestCovid19TestObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

...
public class TestAllTypesObservationContainment extends Containment {
    ...
    public SelectAqlField<CodePhrase> CODED_TEXT_DEFININGCODE = new AqlFieldImp<CodePhrase>(
            TestAllTypesObservation.class,
    ...
    public SelectAqlField<TemporalAccessor> TIME_VALUE_TIME = new AqlFieldImp<TemporalAccessor>(
            TestAllTypesObservation.class,
    ...
    public SelectAqlField<CodePhrase> CODED_TEXT_TERMINOLOGY_DEFININGCODE = new AqlFieldImp<CodePhrase>(
            TestAllTypesObservation.class,

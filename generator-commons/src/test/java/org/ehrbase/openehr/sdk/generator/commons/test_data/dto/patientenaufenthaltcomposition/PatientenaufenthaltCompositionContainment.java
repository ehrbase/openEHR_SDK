...
public class PatientenaufenthaltCompositionContainment extends Containment {
    ...
    public SelectAqlField<VersorgungsfallCluster> VERSORGUNGSFALL = new AqlFieldImp<VersorgungsfallCluster>(
            PatientenaufenthaltComposition.class,
    ...
    public SelectAqlField<AbteilungsfallCluster> ABTEILUNGSFALL = new AqlFieldImp<AbteilungsfallCluster>(
            PatientenaufenthaltComposition.class,
            "/context/other_context[at0001]/items[openEHR-EHR-CLUSTER.case_identification.v0]",
            "abteilungsfall",
    ...
    public SelectAqlField<String> LOCATION = new AqlFieldImp<String>(
            PatientenaufenthaltComposition.class, "/context/location", "location", String.class, this);
    ...
    public SelectAqlField<VersorgungsortAdminEntry> VERSORGUNGSORT = new AqlFieldImp<VersorgungsortAdminEntry>(
            PatientenaufenthaltComposition.class,
    ...
    public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(
            PatientenaufenthaltComposition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

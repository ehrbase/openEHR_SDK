...
public class DienstleistungInstructionContainment extends Containment {
    ...
    public ListSelectAqlField<DienstleistungAktuelleAktivitaetActivity> AKTUELLE_AKTIVITAET =
            new ListAqlFieldImp<DienstleistungAktuelleAktivitaetActivity>(
                    DienstleistungInstruction.class,
                    "/activities[at0001]",
                    "aktuelleAktivitaet",
                    DienstleistungAktuelleAktivitaetActivity.class,
                    this);
    ...
    public SelectAqlField<Cluster> EMPFAENGER = new AqlFieldImp<Cluster>(
            DienstleistungInstruction.class, "/protocol[at0008]/items[at0142]", "empfaenger", Cluster.class, this);

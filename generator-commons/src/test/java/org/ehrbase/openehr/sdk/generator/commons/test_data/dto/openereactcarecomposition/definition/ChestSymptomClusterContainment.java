...
public class ChestSymptomClusterContainment extends Containment {
    public SelectAqlField<ChestSymptomCluster> CHEST_SYMPTOM_CLUSTER = new AqlFieldImp<ChestSymptomCluster>(
    ...
    public SelectAqlField<DvCodedText> SYMPTOM_SIGN_NAME = new AqlFieldImp<DvCodedText>(
            ChestSymptomCluster.class, "/items[at0001.1]/value", "symptomSignName", DvCodedText.class, this);
    ...
    public ListSelectAqlField<Cluster> ASSOCIATED_SYMPTOM_SIGN = new ListAqlFieldImp<Cluster>(
            ChestSymptomCluster.class, "/items[at0063]", "associatedSymptomSign", Cluster.class, this);

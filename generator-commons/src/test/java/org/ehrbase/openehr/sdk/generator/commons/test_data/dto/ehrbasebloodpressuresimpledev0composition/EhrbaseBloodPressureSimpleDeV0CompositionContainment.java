...
public class EhrbaseBloodPressureSimpleDeV0CompositionContainment extends Containment {
    ...
    public SelectAqlField<String> LOCATION = new AqlFieldImp<String>(
            EhrbaseBloodPressureSimpleDeV0Composition.class, "/context/location", "location", String.class, this);
    ...
    public SelectAqlField<PartyProxy> COMPOSER = new AqlFieldImp<PartyProxy>(
            EhrbaseBloodPressureSimpleDeV0Composition.class, "/composer", "composer", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE = new AqlFieldImp<Language>(
            EhrbaseBloodPressureSimpleDeV0Composition.class, "/language", "language", Language.class, this);

    public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(
            EhrbaseBloodPressureSimpleDeV0Composition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);
    ...
    public SelectAqlField<Territory> TERRITORY = new AqlFieldImp<Territory>(
            EhrbaseBloodPressureSimpleDeV0Composition.class, "/territory", "territory", Territory.class, this);

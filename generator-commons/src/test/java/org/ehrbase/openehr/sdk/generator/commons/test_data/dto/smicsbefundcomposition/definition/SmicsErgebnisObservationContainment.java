...
public class SmicsErgebnisObservationContainment extends Containment {
    public SelectAqlField<SmicsErgebnisObservation> SMICS_ERGEBNIS_OBSERVATION = new AqlFieldImp<
            SmicsErgebnisObservation>(
            SmicsErgebnisObservation.class, "", "SmicsErgebnisObservation", SmicsErgebnisObservation.class, this);
    ...
    public SelectAqlField<Boolean> MULTISPEZIES_VALUE = new AqlFieldImp<Boolean>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<TemporalAccessor> BEGINN_DER_UNTERSUCHUNG_VALUE = new AqlFieldImp<TemporalAccessor>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<TemporalAmount> DAUER_VALUE = new AqlFieldImp<TemporalAmount>(
            SmicsErgebnisObservation.class,
    ...
    public ListSelectAqlField<StandortCluster> STANDORT = new ListAqlFieldImp<StandortCluster>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<String> BAUM_KOMMENTAR_VALUE = new AqlFieldImp<String>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<String> UBERTRAGUNGSWEG_VALUE = new AqlFieldImp<String>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<String> TRANSMISSIONSWEG_VALUE = new AqlFieldImp<String>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<String> ART_DER_UBERTRAGUNG_KOMMENTAR_VALUE = new AqlFieldImp<String>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<ErregernameDefiningCode> ERREGERNAME_DEFINING_CODE = new AqlFieldImp<ErregernameDefiningCode>(
            SmicsErgebnisObservation.class,
    ...
    public ListSelectAqlField<SmicsErgebnisAnzahlDerErregernachweiseElement> ANZAHL_DER_ERREGERNACHWEISE =
    ...
    public SelectAqlField<ErregerdetailsCluster> ERREGERDETAILS = new AqlFieldImp<ErregerdetailsCluster>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<ErregertypisierungCluster> ERREGERTYPISIERUNG = new AqlFieldImp<ErregertypisierungCluster>(
            SmicsErgebnisObservation.class,
    ...
    public SelectAqlField<TemporalAccessor> ORIGIN_VALUE = new AqlFieldImp<TemporalAccessor>(
            SmicsErgebnisObservation.class, "/data[at0001]/origin|value", "originValue", TemporalAccessor.class, this);

    public SelectAqlField<PartyProxy> SUBJECT =
            new AqlFieldImp<PartyProxy>(SmicsErgebnisObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE =
            new AqlFieldImp<Language>(SmicsErgebnisObservation.class, "/language", "language", Language.class, this);

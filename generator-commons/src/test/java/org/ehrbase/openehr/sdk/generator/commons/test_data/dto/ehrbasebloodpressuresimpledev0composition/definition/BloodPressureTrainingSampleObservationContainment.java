...
public class BloodPressureTrainingSampleObservationContainment extends Containment {
    public SelectAqlField<BloodPressureTrainingSampleObservation> BLOOD_PRESSURE_TRAINING_SAMPLE_OBSERVATION =
    ...
    public SelectAqlField<NullFlavour> SYSTOLIC_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> DIASTOLIC_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<Double> MEAN_ARTERIAL_PRESSURE_MAGNITUDE = new AqlFieldImp<Double>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<String> MEAN_ARTERIAL_PRESSURE_UNITS = new AqlFieldImp<String>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<Double> PULSE_PRESSURE_MAGNITUDE = new AqlFieldImp<Double>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<String> PULSE_PRESSURE_UNITS = new AqlFieldImp<String>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> PULSE_PRESSURE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<String> COMMENT_VALUE = new AqlFieldImp<String>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> COMMENT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<PositionDefiningCode> POSITION_DEFINING_CODE = new AqlFieldImp<PositionDefiningCode>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> POSITION_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public ListSelectAqlField<Cluster> LEVEL_OF_EXERTION = new ListAqlFieldImp<Cluster>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<Double> TILT_MAGNITUDE = new AqlFieldImp<Double>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<String> TILT_UNITS = new AqlFieldImp<String>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> TILT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<CuffSizeDefiningCode> CUFF_SIZE_DEFINING_CODE = new AqlFieldImp<CuffSizeDefiningCode>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> CUFF_SIZE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<NullFlavour> KOROTKOFF_SOUNDS_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public ListSelectAqlField<Cluster> DEVICE = new ListAqlFieldImp<Cluster>(
            BloodPressureTrainingSampleObservation.class,
    ...
    public SelectAqlField<PartyProxy> SUBJECT = new AqlFieldImp<PartyProxy>(
            BloodPressureTrainingSampleObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE = new AqlFieldImp<Language>(
            BloodPressureTrainingSampleObservation.class, "/language", "language", Language.class, this);

    public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(
            BloodPressureTrainingSampleObservation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

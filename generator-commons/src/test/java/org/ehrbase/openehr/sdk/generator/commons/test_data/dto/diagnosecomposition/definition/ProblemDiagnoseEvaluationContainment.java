...
public class ProblemDiagnoseEvaluationContainment extends Containment {
    ...
    public SelectAqlField<NameDesProblemsDerDiagnoseDefiningCode> NAME_DES_PROBLEMS_DER_DIAGNOSE_DEFINING_CODE =
    ...
    public SelectAqlField<String> FREITEXTBESCHREIBUNG_VALUE = new AqlFieldImp<String>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<String> LOKALISATION_VALUE = new AqlFieldImp<String>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<TemporalAccessor> FESTSTELLUNGSDATUM_VALUE = new AqlFieldImp<TemporalAccessor>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<DiagnosedetailsCluster> DIAGNOSEDETAILS = new AqlFieldImp<DiagnosedetailsCluster>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<AtiopathogeneseCluster> ATIOPATHOGENESE = new AqlFieldImp<AtiopathogeneseCluster>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<TemporalAccessor> DATUM_ZEITPUNKT_DER_GENESUNG_VALUE = new AqlFieldImp<TemporalAccessor>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<String> DIAGNOSEERLAUTERUNG_VALUE = new AqlFieldImp<String>(
            ProblemDiagnoseEvaluation.class,
    ...
    public SelectAqlField<TemporalAccessor> LETZTES_DOKUMENTATIONSDATUM_VALUE = new AqlFieldImp<TemporalAccessor>(
            ProblemDiagnoseEvaluation.class,

...
public class NeuroSymptomClusterContainment extends Containment {
    public SelectAqlField<NeuroSymptomCluster> NEURO_SYMPTOM_CLUSTER = new AqlFieldImp<NeuroSymptomCluster>(
    ...
    public SelectAqlField<DvCodedText> SYMPTOM_SIGN_NAME = new AqlFieldImp<DvCodedText>(
            NeuroSymptomCluster.class, "/items[at0001.1]/value", "symptomSignName", DvCodedText.class, this);
    ...
    public ListSelectAqlField<Cluster> ASSOCIATED_SYMPTOM_SIGN = new ListAqlFieldImp<Cluster>(
            NeuroSymptomCluster.class, "/items[at0063]", "associatedSymptomSign", Cluster.class, this);

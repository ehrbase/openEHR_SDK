...
public class FieberOderErhoehteKoerpertemperaturObservationContainment extends Containment {
    ...
    public SelectAqlField<PartyProxy> SUBJECT = new AqlFieldImp<PartyProxy>(
            FieberOderErhoehteKoerpertemperaturObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE = new AqlFieldImp<Language>(
            FieberOderErhoehteKoerpertemperaturObservation.class, "/language", "language", Language.class, this);

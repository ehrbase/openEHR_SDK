...
public class DenwisObservationContainment extends Containment {
    public SelectAqlField<DenwisObservation> DENWIS_OBSERVATION = new AqlFieldImp<DenwisObservation>(
            DenwisObservation.class, "", "DenwisObservation", DenwisObservation.class, this);

    public SelectAqlField<DvOrdinal> Q1_BREATHING = new AqlFieldImp<DvOrdinal>(
    ...
    public SelectAqlField<DvOrdinal> Q2_CIRCULATION = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q3_TEMPERATURE = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q4_MENTATION = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q5_AGITATION = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q6_PAIN = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q7_TRAJECTORY = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q8_PATIENT_SUBJECTIVE = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<DvOrdinal> Q9_NURSE_SUBJECTIVE = new AqlFieldImp<DvOrdinal>(
            DenwisObservation.class,
    ...
    public SelectAqlField<String> Q10_OTHER_COMMENT_VALUE = new AqlFieldImp<String>(
            DenwisObservation.class,
    ...
    public SelectAqlField<ItemTree> TREE = new AqlFieldImp<ItemTree>(
            DenwisObservation.class, "/data[at0001]/events[at0002]/state[at0006]", "tree", ItemTree.class, this);
    ...
    public SelectAqlField<TemporalAccessor> ORIGIN_VALUE = new AqlFieldImp<TemporalAccessor>(
            DenwisObservation.class, "/data[at0001]/origin|value", "originValue", TemporalAccessor.class, this);

    public ListSelectAqlField<Cluster> EXTENSION = new ListAqlFieldImp<Cluster>(
            DenwisObservation.class, "/protocol[at0004]/items[at0005]", "extension", Cluster.class, this);

    public SelectAqlField<PartyProxy> SUBJECT =
            new AqlFieldImp<PartyProxy>(DenwisObservation.class, "/subject", "subject", PartyProxy.class, this);

    public SelectAqlField<Language> LANGUAGE =
            new AqlFieldImp<Language>(DenwisObservation.class, "/language", "language", Language.class, this);

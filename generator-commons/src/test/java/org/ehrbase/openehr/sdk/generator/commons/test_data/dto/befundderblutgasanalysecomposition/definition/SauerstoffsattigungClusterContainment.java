...
public class SauerstoffsattigungClusterContainment extends Containment {
    public SelectAqlField<SauerstoffsattigungCluster> SAUERSTOFFSATTIGUNG_CLUSTER = new AqlFieldImp<
            SauerstoffsattigungCluster>(
            SauerstoffsattigungCluster.class, "", "SauerstoffsattigungCluster", SauerstoffsattigungCluster.class, this);
    ...
    public SelectAqlField<String> ANALYT_RESULTAT_UNITS = new AqlFieldImp<String>(
            SauerstoffsattigungCluster.class, "/items[at0001]/value|units", "analytResultatUnits", String.class, this);

    public ListSelectAqlField<Cluster> ANALYSEERGEBNIS_DETAILS = new ListAqlFieldImp<Cluster>(
            SauerstoffsattigungCluster.class, "/items[at0014]", "analyseergebnisDetails", Cluster.class, this);

    public SelectAqlField<String> ERGEBNIS_STATUS_VALUE = new AqlFieldImp<String>(
            SauerstoffsattigungCluster.class, "/items[at0005]/value|value", "ergebnisStatusValue", String.class, this);

    public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(
            SauerstoffsattigungCluster.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

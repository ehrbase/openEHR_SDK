...
public class ProVirusClusterContainment extends Containment {
    public SelectAqlField<ProVirusCluster> PRO_VIRUS_CLUSTER =
            new AqlFieldImp<ProVirusCluster>(ProVirusCluster.class, "", "ProVirusCluster", ProVirusCluster.class, this);

    public SelectAqlField<Long> ANALYSEERGEBNIS_REIHENFOLGE_MAGNITUDE = new AqlFieldImp<Long>(
    ...
    public SelectAqlField<String> VIRUS_VALUE = new AqlFieldImp<String>(
            ProVirusCluster.class, "/items[at0024]/value|value", "virusValue", String.class, this);

    public SelectAqlField<String> NACHWEIS_VALUE = new AqlFieldImp<String>(
            ProVirusCluster.class, "/items[at0001]/value|value", "nachweisValue", String.class, this);

    public SelectAqlField<Double> VIRUSLAST_CT_WERT_MAGNITUDE = new AqlFieldImp<Double>(
            ProVirusCluster.class, "/items[at0001]/value|magnitude", "viruslastCtWertMagnitude", Double.class, this);

    public SelectAqlField<String> VIRUSLAST_CT_WERT_UNITS = new AqlFieldImp<String>(
            ProVirusCluster.class, "/items[at0001]/value|units", "viruslastCtWertUnits", String.class, this);
    ...
    public SelectAqlField<DvIdentifier> ZUGEHORIGE_LABORPROBE = new AqlFieldImp<DvIdentifier>(
            ProVirusCluster.class, "/items[at0026]/value", "zugehorigeLaborprobe", DvIdentifier.class, this);

    public SelectAqlField<String> KOMMENTAR_VALUE = new AqlFieldImp<String>(
            ProVirusCluster.class, "/items[at0003]/value|value", "kommentarValue", String.class, this);

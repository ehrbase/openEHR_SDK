...
public enum NameDesProblemsDerDiagnoseDefiningCode implements EnumValueSet {
    ...
    COVID19_VIRUS_NICHT_NACHGEWIESEN(
            "COVID-19, Virus nicht nachgewiesen", "COVID-19, Virus nicht nachgewiesen", "ICD-10-GM-2020", "U07.2");
    ...
    NameDesProblemsDerDiagnoseDefiningCode(String value, String description, String terminologyId, String code) {
        this.value = value;

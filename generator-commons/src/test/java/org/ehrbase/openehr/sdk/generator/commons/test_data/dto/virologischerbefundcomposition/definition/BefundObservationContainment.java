...
public class BefundObservationContainment extends Containment {
    ...
    public SelectAqlField<String> LABORTEST_BEZEICHNUNG_VALUE = new AqlFieldImp<String>(
    ...
    public ListSelectAqlField<ProbeCluster> PROBE = new ListAqlFieldImp<ProbeCluster>(
            BefundObservation.class,
    ...
    public ListSelectAqlField<KulturCluster> KULTUR = new ListAqlFieldImp<KulturCluster>(
            BefundObservation.class,
    ...
    public SelectAqlField<EmpfangerstandortCluster> EMPFANGERSTANDORT = new AqlFieldImp<EmpfangerstandortCluster>(
            BefundObservation.class,
    ...
    public ListSelectAqlField<BefundAnforderungElement> ANFORDERUNG = new ListAqlFieldImp<BefundAnforderungElement>(
            BefundObservation.class,
    ...
    public SelectAqlField<DvIdentifier> AUFTRAGS_ID_EMPFANGER = new AqlFieldImp<DvIdentifier>(
            BefundObservation.class,
    ...
    public SelectAqlField<EinsenderstandortCluster> EINSENDERSTANDORT = new AqlFieldImp<EinsenderstandortCluster>(
            BefundObservation.class,

...
import static org.ehrbase.openehr.sdk.generator.commons.aql.condition.ComparisonOperator.*;
...
public interface Condition {
    ...
    static <T> Condition like(SelectAqlField<T> field, T value) {
        return valueComparison(field, "like", value);
    }

    static <T> Condition like(SelectAqlField<T> field, Parameter<T> parameter) {
        return parameterComparison(field, "like", parameter);
    }

...
public class StoredQueryDefinition {
    ...
    public StoredQueryDefinition(String qualifiedQueryName, String version) {
        this.qualifiedQueryName = qualifiedQueryName;
        this.version = version;
    }

    public StoredQueryDefinition(String qualifiedQueryName, String version, String type) {
        this.qualifiedQueryName = qualifiedQueryName;
        this.version = version;
        this.type = type;
    }

    public StoredQueryDefinition type(String value) {
        this.type = value;
        return this;
    }

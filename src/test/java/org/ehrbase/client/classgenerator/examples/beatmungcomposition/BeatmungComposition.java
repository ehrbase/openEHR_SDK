...
@Template("Beatmung")
public class BeatmungComposition {
  @Id
  ...
  private List<BeobachtungenAmBeatmungsgeratObservation> beobachtungenAmBeatmungsgerat;
  ...
  public void setBeobachtungenAmBeatmungsgerat(
      List<BeobachtungenAmBeatmungsgeratObservation> beobachtungenAmBeatmungsgerat) {
     this.beobachtungenAmBeatmungsgerat = beobachtungenAmBeatmungsgerat;
  }

  public List<BeobachtungenAmBeatmungsgeratObservation> getBeobachtungenAmBeatmungsgerat() {
     return this.beobachtungenAmBeatmungsgerat ;
  }

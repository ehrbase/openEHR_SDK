...
public class FallidentifikationClusterContainment extends Containment {
  ...
  public SelectAqlField<String> FALL_KENNUNG_VALUE_NAME = new AqlFieldImp<String>(FallidentifikationCluster.class, "/items[at0001]/name|value", "fallKennungValueName", String.class, this);

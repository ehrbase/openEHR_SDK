...
public class StationarerVersorgungsfallCompositionContainment extends Containment {
  ...
  public SelectAqlField<PatientenaufnahmeAdminEntry> PATIENTENAUFNAHME = new AqlFieldImp<PatientenaufnahmeAdminEntry>(StationarerVersorgungsfallComposition.class, "/content[openEHR-EHR-ADMIN_ENTRY.admission.v0]", "patientenaufnahme", PatientenaufnahmeAdminEntry.class, this);

  public SelectAqlField<String> FALL_ID_VALUE = new AqlFieldImp<String>(StationarerVersorgungsfallComposition.class, "/context/other_context[at0001]/items[at0003]/value|value", "fallIdValue", String.class, this);
  ...
  public SelectAqlField<String> FALL_ID_VALUE_BAUM = new AqlFieldImp<String>(StationarerVersorgungsfallComposition.class, "/context/other_context[at0001]/items[at0003]/name|value", "fallIdValueBaum", String.class, this);

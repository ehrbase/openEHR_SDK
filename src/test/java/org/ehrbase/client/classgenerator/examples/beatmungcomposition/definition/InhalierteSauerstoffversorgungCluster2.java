...
public class InhalierteSauerstoffversorgungCluster2 {
  ...
  private List<InhalierteSauerstoffversorgungLeckageDerMaskeElementMaske> leckageDerMaske;
  ...
  public void setLeckageDerMaske(
      List<InhalierteSauerstoffversorgungLeckageDerMaskeElementMaske> leckageDerMaske) {
     this.leckageDerMaske = leckageDerMaske;
  }

  public List<InhalierteSauerstoffversorgungLeckageDerMaskeElementMaske> getLeckageDerMaske() {

...
public class MesswerteCluster {
  ...
  private InhalierteSauerstoffversorgungCluster inhalierteSauerstoffversorgung;
  ...
  @Path("/items[at0114]")
  private List<LuftsauerstoffBeatmungsformSubmodeElement> beatmungsformSubmode;
  ...
  public void setInhalierteSauerstoffversorgung(
      InhalierteSauerstoffversorgungCluster inhalierteSauerstoffversorgung) {
     this.inhalierteSauerstoffversorgung = inhalierteSauerstoffversorgung;
  }

  public InhalierteSauerstoffversorgungCluster getInhalierteSauerstoffversorgung() {
  ...
  public void setBeatmungsformSubmode(
      List<LuftsauerstoffBeatmungsformSubmodeElement> beatmungsformSubmode) {
     this.beatmungsformSubmode = beatmungsformSubmode;
  }

  public List<LuftsauerstoffBeatmungsformSubmodeElement> getBeatmungsformSubmode() {

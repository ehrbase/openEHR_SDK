package org.ehrbase.client.classgenerator.examples.kennzeichnungerregernachweissarscov2composition.definition;
...
public class KennzeichnungErregernachweisEvaluationContainment extends Containment {
  ...
  public SelectAqlField<String> ERREGERNAME_VALUE = new AqlFieldImp<String>(KennzeichnungErregernachweisEvaluation.class, "/data[at0001]/items[at0012]/value|value", "erregernameValue", String.class, this);

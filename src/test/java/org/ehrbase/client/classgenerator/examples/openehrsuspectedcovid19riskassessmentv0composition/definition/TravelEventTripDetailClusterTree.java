...
@Entity
public class TravelEventTripDetailClusterTree {
  @Path("/items[at0010]")
  private List<TravelEventTravelDestinationCluster2> travelDestination;
  ...
  public void setTravelDestination(List<TravelEventTravelDestinationCluster2> travelDestination) {
     this.travelDestination = travelDestination;
  }

  public List<TravelEventTravelDestinationCluster2> getTravelDestination() {

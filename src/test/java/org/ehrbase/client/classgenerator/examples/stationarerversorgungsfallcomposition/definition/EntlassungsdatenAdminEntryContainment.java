...
public class EntlassungsdatenAdminEntryContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> ZUGEWIESENER_PATIENTENSTANDORT = new ListAqlFieldImp<Cluster>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0067]", "zugewiesenerPatientenstandort", Cluster.class, this);

  public SelectAqlField<KlinischerZustandDesPatientenDefiningcode> KLINISCHER_ZUSTAND_DES_PATIENTEN_DEFININGCODE = new AqlFieldImp<KlinischerZustandDesPatientenDefiningcode>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0002]/value|defining_code", "klinischerZustandDesPatientenDefiningcode", KlinischerZustandDesPatientenDefiningcode.class, this);
  ...
  public SelectAqlField<String> ZUSATZLICHE_INFORMATIONEN_VALUE = new AqlFieldImp<String>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0050]/value|value", "zusatzlicheInformationenValue", String.class, this);
  ...
  public SelectAqlField<String> UHRZEIT_VALUE = new AqlFieldImp<String>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0011]/name|value", "uhrzeitValue", String.class, this);

  public SelectAqlField<String> ART_DER_ENTLASSUNG_VALUE = new AqlFieldImp<String>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0040]/value|value", "artDerEntlassungValue", String.class, this);

  public SelectAqlField<TemporalAccessor> UHRZEIT_VALUE_ENTLASSUNGSDATUM = new AqlFieldImp<TemporalAccessor>(EntlassungsdatenAdminEntry.class, "/data[at0001]/items[at0011]/value|value", "uhrzeitValueEntlassungsdatum", TemporalAccessor.class, this);
